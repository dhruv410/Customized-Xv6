...
int main(int argc, char *argv[]){
  ...
  3a:	e8 73 03 00 00       	call   3b2 <getpid>
  ...
  85:	eb e5                	jmp    6c <main+0x6c>
                int pid = getpid();
  87:	e8 26 03 00 00       	call   3b2 <getpid>
                for (z = 0; z < limit/2; z += 1)
  8c:	d9 ee                	fldz   
  8e:	66 90                	xchg   %ax,%ax
  ...
  a0:	dd d8                	fstp   %st(0)
                set_priority(100 - pid/2, pid);
  a2:	b9 02 00 00 00       	mov    $0x2,%ecx
  a7:	52                   	push   %edx
  a8:	52                   	push   %edx
  a9:	99                   	cltd   
  aa:	50                   	push   %eax
  ab:	f7 f9                	idiv   %ecx
  ad:	f7 d8                	neg    %eax
  af:	83 c0 64             	add    $0x64,%eax
  b2:	50                   	push   %eax
  b3:	e8 22 03 00 00       	call   3da <set_priority>
                for (z = 0; z < limit/2; z += 1)
  b8:	d9 ee                	fldz   
                set_priority(100 - pid/2, pid);
