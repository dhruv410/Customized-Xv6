...
80100193:	68 2e 77 10 80       	push   $0x8010772e
...
801001cc:	68 3f 77 10 80       	push   $0x8010773f
...
80100264:	68 46 77 10 80       	push   $0x80107746
...
801003b2:	68 4d 77 10 80       	push   $0x8010774d
...
801003e8:	68 61 77 10 80       	push   $0x80107761
...
8010043a:	e8 e1 5e 00 00       	call   80106320 <uartputc>
...
801004ec:	e8 2f 5e 00 00       	call   80106320 <uartputc>
801004f1:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f8:	e8 23 5e 00 00       	call   80106320 <uartputc>
801004fd:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100504:	e8 17 5e 00 00       	call   80106320 <uartputc>
...
80100551:	68 65 77 10 80       	push   $0x80107765
...
801005b1:	0f b6 92 90 77 10 80 	movzbl -0x7fef8870(%edx),%edx
  }while((x /= base) != 0);
...
801007cf:	90                   	nop
        s = "(null)";
801007d0:	ba 78 77 10 80       	mov    $0x80107778,%edx
      for(; *s; s++)
...
80100800:	68 7f 77 10 80       	push   $0x8010777f
...
801009c6:	68 88 77 10 80       	push   $0x80107788
...
80100a92:	75 d2                	jne    80100a66 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a94:	e8 d7 69 00 00       	call   80107470 <setupkvm>
...
80100af6:	e8 95 67 00 00       	call   80107290 <allocuvm>
...
80100b72:	e8 79 68 00 00       	call   801073f0 <freevm>
...
80100baa:	e8 e1 66 00 00       	call   80107290 <allocuvm>
...
80100bc1:	e8 2a 68 00 00       	call   801073f0 <freevm>
...
80100bdb:	68 a1 77 10 80       	push   $0x801077a1
...
80100c06:	e8 05 69 00 00       	call   80107510 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c5d:	e8 0e 6a 00 00       	call   80107670 <copyout>
...
80100d0a:	e8 31 40 00 00       	call   80104d40 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100d34:	e8 07 63 00 00       	call   80107040 <switchuvm>
  freevm(oldpgdir);
80100d39:	89 3c 24             	mov    %edi,(%esp)
80100d3c:	e8 af 66 00 00       	call   801073f0 <freevm>
  return 0;
...
80100d66:	68 ad 77 10 80       	push   $0x801077ad
...
80100d91:	e8 ba 3c 00 00       	call   80104a50 <acquire>
...
80100dc1:	e8 4a 3d 00 00       	call   80104b10 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100dda:	e8 31 3d 00 00       	call   80104b10 <release>
}
...
80100dff:	e8 4c 3c 00 00       	call   80104a50 <acquire>
  if(f->ref < 1)
...
80100e1c:	e8 ef 3c 00 00       	call   80104b10 <release>
  return f;
}
...
80100e2b:	68 b4 77 10 80       	push   $0x801077b4
...
80100e51:	e8 fa 3b 00 00       	call   80104a50 <acquire>
  if(f->ref < 1)
...
80100e7b:	5d                   	pop    %ebp
    release(&ftable.lock);
80100e7c:	e9 8f 3c 00 00       	jmp    80104b10 <release>
...
80100ea5:	89 45 e0             	mov    %eax,-0x20(%ebp)
  release(&ftable.lock);
80100ea8:	e8 63 3c 00 00       	call   80104b10 <release>
  if(ff.type == FD_PIPE)
...
80100f02:	68 bc 77 10 80       	push   $0x801077bc
...
80100fe2:	68 c6 77 10 80       	push   $0x801077c6
...
801010f5:	68 cf 77 10 80       	push   $0x801077cf
801010fa:	e8 91 f2 ff ff       	call   80100390 <panic>
  panic("filewrite");
801010ff:	83 ec 0c             	sub    $0xc,%esp
80101102:	68 d5 77 10 80       	push   $0x801077d5
...
80101173:	68 df 77 10 80       	push   $0x801077df
...
80101224:	68 f2 77 10 80       	push   $0x801077f2
...
80101265:	e8 f6 38 00 00       	call   80104b60 <memset>
  log_write(bp);
...
8010130f:	e8 fc 37 00 00       	call   80104b10 <release>
...
8010133a:	89 4b 08             	mov    %ecx,0x8(%ebx)
      release(&icache.lock);
8010133d:	e8 ce 37 00 00       	call   80104b10 <release>
      return ip;
...
80101352:	68 08 78 10 80       	push   $0x80107808
...
80101427:	68 18 78 10 80       	push   $0x80107818
...
80101461:	e8 aa 37 00 00       	call   80104c10 <memmove>
  brelse(bp);
...
8010148c:	68 2b 78 10 80       	push   $0x8010782b
80101491:	68 20 22 11 80       	push   $0x80112220
80101496:	e8 75 34 00 00       	call   80104910 <initlock>
8010149b:	83 c4 10             	add    $0x10,%esp
8010149e:	66 90                	xchg   %ax,%ax
    initsleeplock(&icache.inode[i].lock, "inode");
801014a0:	83 ec 08             	sub    $0x8,%esp
801014a3:	68 32 78 10 80       	push   $0x80107832
801014a8:	53                   	push   %ebx
801014a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
801014af:	e8 2c 33 00 00       	call   801047e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801014f9:	68 98 78 10 80       	push   $0x80107898
...
8010158e:	e8 cd 35 00 00       	call   80104b60 <memset>
      dip->type = type;
...
801015c3:	68 38 78 10 80       	push   $0x80107838
...
80101631:	e8 da 35 00 00       	call   80104c10 <memmove>
  log_write(bp);
...
8010165f:	e8 ec 33 00 00       	call   80104a50 <acquire>
  ip->ref++;
80101664:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101668:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
8010166f:	e8 9c 34 00 00       	call   80104b10 <release>
}
...
801016a2:	e8 79 31 00 00       	call   80104820 <acquiresleep>
  if(ip->valid == 0){
...
80101718:	e8 f3 34 00 00       	call   80104c10 <memmove>
    brelse(bp);
...
8010173d:	68 50 78 10 80       	push   $0x80107850
80101742:	e8 49 ec ff ff       	call   80100390 <panic>
    panic("ilock");
80101747:	83 ec 0c             	sub    $0xc,%esp
8010174a:	68 4a 78 10 80       	push   $0x8010784a
...
80101773:	e8 48 31 00 00       	call   801048c0 <holdingsleep>
...
8010178e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010178f:	e9 ec 30 00 00       	jmp    80104880 <releasesleep>
    panic("iunlock");
80101794:	83 ec 0c             	sub    $0xc,%esp
80101797:	68 5f 78 10 80       	push   $0x8010785f
...
801017c0:	e8 5b 30 00 00       	call   80104820 <acquiresleep>
...
801017da:	e8 a1 30 00 00       	call   80104880 <releasesleep>
  acquire(&icache.lock);
801017df:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
801017e6:	e8 65 32 00 00       	call   80104a50 <acquire>
  ip->ref--;
...
801017ff:	5d                   	pop    %ebp
  release(&icache.lock);
80101800:	e9 0b 33 00 00       	jmp    80104b10 <release>
80101805:	8d 76 00             	lea    0x0(%esi),%esi
    acquire(&icache.lock);
80101808:	83 ec 0c             	sub    $0xc,%esp
8010180b:	68 20 22 11 80       	push   $0x80112220
80101810:	e8 3b 32 00 00       	call   80104a50 <acquire>
    int r = ip->ref;
80101815:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101818:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
8010181f:	e8 ec 32 00 00       	call   80104b10 <release>
    if(r == 1){
...
80101a05:	01 de                	add    %ebx,%esi
    memmove(dst, bp->data + off%BSIZE, m);
80101a07:	e8 04 32 00 00       	call   80104c10 <memmove>
    brelse(bp);
...
80101b03:	e8 08 31 00 00       	call   80104c10 <memmove>
    log_write(bp);
...
80101b9e:	e8 dd 30 00 00       	call   80104c80 <strncmp>
}
80101ba3:	c9                   	leave  
80101ba4:	c3                   	ret    
...
80101bfd:	e8 7e 30 00 00       	call   80104c80 <strncmp>
      continue;
...
80101c42:	68 79 78 10 80       	push   $0x80107879
80101c47:	e8 44 e7 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101c4c:	83 ec 0c             	sub    $0xc,%esp
80101c4f:	68 67 78 10 80       	push   $0x80107867
...
80101c89:	e8 c2 2d 00 00       	call   80104a50 <acquire>
  ip->ref++;
80101c8e:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101c92:	c7 04 24 20 22 11 80 	movl   $0x80112220,(%esp)
80101c99:	e8 72 2e 00 00       	call   80104b10 <release>
...
80101cf5:	e8 16 2f 00 00       	call   80104c10 <memmove>
    path++;
...
80101d88:	e8 83 2e 00 00       	call   80104c10 <memmove>
    name[len] = 0;
...
80101ebb:	68 88 78 10 80       	push   $0x80107888
...
80101fdb:	68 f4 78 10 80       	push   $0x801078f4
80101fe0:	e8 ab e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80101fe5:	83 ec 0c             	sub    $0xc,%esp
80101fe8:	68 eb 78 10 80       	push   $0x801078eb
...
80102006:	68 06 79 10 80       	push   $0x80107906
8010200b:	68 80 b5 10 80       	push   $0x8010b580
80102010:	e8 fb 28 00 00       	call   80104910 <initlock>
...
8010208e:	e8 bd 29 00 00       	call   80104a50 <acquire>
...
801020f1:	e8 aa 20 00 00       	call   801041a0 <wakeup>
...
8010210f:	e8 fc 29 00 00       	call   80104b10 <release>
...
8010212e:	e8 8d 27 00 00       	call   801048c0 <holdingsleep>
...
80102168:	e8 e3 28 00 00       	call   80104a50 <acquire>
...
801021b9:	e8 02 1d 00 00       	call   80103ec0 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801021d5:	c9                   	leave  
  release(&idelock);
801021d6:	e9 35 29 00 00       	jmp    80104b10 <release>
801021db:	90                   	nop
...
801021fa:	68 20 79 10 80       	push   $0x80107920
801021ff:	e8 8c e1 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102204:	83 ec 0c             	sub    $0xc,%esp
80102207:	68 0a 79 10 80       	push   $0x8010790a
8010220c:	e8 7f e1 ff ff       	call   80100390 <panic>
    panic("iderw: ide disk 1 not present");
80102211:	83 ec 0c             	sub    $0xc,%esp
80102214:	68 35 79 10 80       	push   $0x80107935
...
80102267:	68 54 79 10 80       	push   $0x80107954
...
80102342:	e8 19 28 00 00       	call   80104b60 <memset>
...
8010237a:	c9                   	leave  
    release(&kmem.lock);
8010237b:	e9 90 27 00 00       	jmp    80104b10 <release>
    acquire(&kmem.lock);
80102380:	83 ec 0c             	sub    $0xc,%esp
80102383:	68 80 3e 11 80       	push   $0x80113e80
80102388:	e8 c3 26 00 00       	call   80104a50 <acquire>
8010238d:	83 c4 10             	add    $0x10,%esp
80102390:	eb c2                	jmp    80102354 <kfree+0x44>
    panic("kfree");
80102392:	83 ec 0c             	sub    $0xc,%esp
80102395:	68 86 79 10 80       	push   $0x80107986
...
801023fb:	68 8c 79 10 80       	push   $0x8010798c
80102400:	68 80 3e 11 80       	push   $0x80113e80
80102405:	e8 06 25 00 00       	call   80104910 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
801024f3:	e8 58 25 00 00       	call   80104a50 <acquire>
  r = kmem.freelist;
...
80102521:	e8 ea 25 00 00       	call   80104b10 <release>
  return (char*)r;
...
80102573:	0f b6 82 c0 7a 10 80 	movzbl -0x7fef8540(%edx),%eax
8010257a:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
8010257c:	0f b6 82 c0 79 10 80 	movzbl -0x7fef8640(%edx),%eax
...
80102590:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
80102593:	8b 04 85 a0 79 10 80 	mov    -0x7fef8660(,%eax,4),%eax
...
801025b5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025b8:	0f b6 82 c0 7a 10 80 	movzbl -0x7fef8540(%edx),%eax
...
80102937:	e8 74 22 00 00       	call   80104bb0 <memcmp>
...
80102a64:	e8 a7 21 00 00       	call   80104c10 <memmove>
...
80102b0a:	68 c0 7b 10 80       	push   $0x80107bc0
80102b0f:	68 c0 3e 11 80       	push   $0x80113ec0
80102b14:	e8 f7 1d 00 00       	call   80104910 <initlock>
  readsb(dev, &sb);
80102b19:	58                   	pop    %eax
...
80102bab:	e8 a0 1e 00 00       	call   80104a50 <acquire>
...
80102bc5:	e8 f6 12 00 00       	call   80103ec0 <sleep>
...
80102bfc:	e8 0f 1f 00 00       	call   80104b10 <release>
      break;
    }
  }
}
...
80102c1e:	e8 2d 1e 00 00       	call   80104a50 <acquire>
  log.outstanding -= 1;
...
80102cb6:	e8 55 1f 00 00       	call   80104c10 <memmove>
...
80102cff:	e8 4c 1d 00 00       	call   80104a50 <acquire>
    wakeup(&log);
...
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 86 14 00 00       	call   801041a0 <wakeup>
    release(&log.lock);
80102d1a:	c7 04 24 c0 3e 11 80 	movl   $0x80113ec0,(%esp)
80102d21:	e8 ea 1d 00 00       	call   80104b10 <release>
...
80102d40:	e8 5b 14 00 00       	call   801041a0 <wakeup>
  release(&log.lock);
80102d45:	c7 04 24 c0 3e 11 80 	movl   $0x80113ec0,(%esp)
80102d4c:	e8 bf 1d 00 00       	call   80104b10 <release>
...
80102d5f:	68 c4 7b 10 80       	push   $0x80107bc4
...
80102dae:	e8 9d 1c 00 00       	call   80104a50 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102dfc:	c9                   	leave  
  release(&log.lock);
80102dfd:	e9 0e 1d 00 00       	jmp    80104b10 <release>
...
80102e29:	68 d3 7b 10 80       	push   $0x80107bd3
80102e2e:	e8 5d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e33:	83 ec 0c             	sub    $0xc,%esp
80102e36:	68 e9 7b 10 80       	push   $0x80107be9
...
80102e58:	68 04 7c 10 80       	push   $0x80107c04
80102e5d:	e8 fe d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e62:	e8 79 30 00 00       	call   80105ee0 <idtinit>
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 95 41 00 00       	call   80107020 <switchkvm>
  seginit();
80102e8b:	e8 00 41 00 00       	call   80106f90 <seginit>
  lapicinit();
...
80102f1f:	e8 3c 33 00 00       	call   80106260 <uartinit>
  pinit();         // process table
80102f24:	e8 c7 08 00 00       	call   801037f0 <pinit>
  tvinit();        // trap vectors
80102f29:	e8 32 2f 00 00       	call   80105e60 <tvinit>
  binit();         // buffer cache
...
80102f4f:	e8 bc 1c 00 00       	call   80104c10 <memmove>
...
8010302e:	68 18 7c 10 80       	push   $0x80107c18
80103033:	56                   	push   %esi
80103034:	e8 77 1b 00 00       	call   80104bb0 <memcmp>
...
801030ec:	68 35 7c 10 80       	push   $0x80107c35
801030f1:	56                   	push   %esi
801030f2:	e8 b9 1a 00 00       	call   80104bb0 <memcmp>
...
80103180:	ff 24 95 5c 7c 10 80 	jmp    *-0x7fef83a4(,%edx,4)
...
80103233:	68 1d 7c 10 80       	push   $0x80107c1d
80103238:	e8 53 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
8010323d:	83 ec 0c             	sub    $0xc,%esp
80103240:	68 3c 7c 10 80       	push   $0x80107c3c
...
80103338:	00 00 00 
  initlock(&p->lock, "pipe");
8010333b:	68 70 7c 10 80       	push   $0x80107c70
80103340:	50                   	push   %eax
80103341:	e8 ca 15 00 00       	call   80104910 <initlock>
  (*f0)->type = FD_PIPE;
...
8010339f:	e8 ac 16 00 00       	call   80104a50 <acquire>
  if(writable){
...
801033bf:	e8 dc 0d 00 00       	call   801041a0 <wakeup>
...
801033e3:	5d                   	pop    %ebp
    release(&p->lock);
801033e4:	e9 27 17 00 00       	jmp    80104b10 <release>
...
80103404:	e8 97 0d 00 00       	call   801041a0 <wakeup>
...
80103414:	e8 f7 16 00 00       	call   80104b10 <release>
    kfree((char*)p);
...
8010343d:	e8 0e 16 00 00       	call   80104a50 <acquire>
  for(i = 0; i < n; i++){
...
80103494:	e8 07 0d 00 00       	call   801041a0 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103499:	5a                   	pop    %edx
8010349a:	59                   	pop    %ecx
8010349b:	53                   	push   %ebx
8010349c:	56                   	push   %esi
8010349d:	e8 1e 0a 00 00       	call   80103ec0 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
801034d4:	e8 37 16 00 00       	call   80104b10 <release>
        return -1;
...
80103523:	e8 78 0c 00 00       	call   801041a0 <wakeup>
  release(&p->lock);
80103528:	89 1c 24             	mov    %ebx,(%esp)
8010352b:	e8 e0 15 00 00       	call   80104b10 <release>
  return n;
...
80103550:	e8 fb 14 00 00       	call   80104a50 <acquire>
...
80103585:	e8 36 09 00 00       	call   80103ec0 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
801035be:	e8 4d 15 00 00       	call   80104b10 <release>
      return -1;
...
80103617:	e8 84 0b 00 00       	call   801041a0 <wakeup>
  release(&p->lock);
8010361c:	89 34 24             	mov    %esi,(%esp)
8010361f:	e8 ec 14 00 00       	call   80104b10 <release>
  return i;
...
80103644:	bb 94 45 11 80       	mov    $0x80114594,%ebx
{
80103649:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
8010364c:	68 60 45 11 80       	push   $0x80114560
80103651:	e8 fa 13 00 00       	call   80104a50 <acquire>
...
80103666:	81 fb 94 71 11 80    	cmp    $0x80117194,%ebx
...
801036b3:	89 43 10             	mov    %eax,0x10(%ebx)
  p->startTime = ticks;
801036b6:	a1 e0 79 11 80       	mov    0x801179e0,%eax
  p->queue = 0;
...
8010370b:	00 00 00 
  release(&ptable.lock);
8010370e:	68 60 45 11 80       	push   $0x80114560
  p->pid = nextpid++;
80103713:	89 15 04 b0 10 80    	mov    %edx,0x8010b004
  release(&ptable.lock);
80103719:	e8 f2 13 00 00       	call   80104b10 <release>
...
8010373b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
8010373e:	c7 40 14 47 5e 10 80 	movl   $0x80105e47,0x14(%eax)
  p->context = (struct context*)sp;
...
8010374d:	e8 0e 14 00 00       	call   80104b60 <memset>
...
80103773:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103775:	68 60 45 11 80       	push   $0x80114560
8010377a:	e8 91 13 00 00       	call   80104b10 <release>
}
...
801037a3:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
801037a6:	68 60 45 11 80       	push   $0x80114560
801037ab:	e8 60 13 00 00       	call   80104b10 <release>
...
801037f6:	68 75 7c 10 80       	push   $0x80107c75
801037fb:	68 60 45 11 80       	push   $0x80114560
80103800:	e8 0b 11 00 00       	call   80104910 <initlock>
}
...
8010381c:	e8 0f ef ff ff       	call   80102730 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103821:	8b 35 40 45 11 80    	mov    0x80114540,%esi
80103827:	85 f6                	test   %esi,%esi
80103829:	7e 42                	jle    8010386d <mycpu+0x5d>
    if (cpus[i].apicid == apicid)
8010382b:	0f b6 15 c0 3f 11 80 	movzbl 0x80113fc0,%edx
80103832:	39 d0                	cmp    %edx,%eax
80103834:	74 30                	je     80103866 <mycpu+0x56>
80103836:	b9 70 40 11 80       	mov    $0x80114070,%ecx
  for (i = 0; i < ncpu; ++i) {
...
8010385a:	05 c0 3f 11 80       	add    $0x80113fc0,%eax
}
...
8010389b:	2d c0 3f 11 80       	sub    $0x80113fc0,%eax
}
801038a0:	c9                   	leave  
  return mycpu()-cpus;
...
801038b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801038b7:	e8 c4 10 00 00       	call   80104980 <pushcli>
  c = mycpu();
801038bc:	e8 4f ff ff ff       	call   80103810 <mycpu>
  p = c->proc;
801038c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801038c7:	e8 f4 10 00 00       	call   801049c0 <popcli>
}
...
801038f3:	e8 78 3b 00 00       	call   80107470 <setupkvm>
...
80103911:	e8 3a 38 00 00       	call   80107150 <inituvm>
...
80103926:	e8 35 12 00 00       	call   80104b60 <memset>
...
8010397f:	68 a5 7c 10 80       	push   $0x80107ca5
80103984:	50                   	push   %eax
80103985:	e8 b6 13 00 00       	call   80104d40 <safestrcpy>
  p->cwd = namei("/");
8010398a:	c7 04 24 ae 7c 10 80 	movl   $0x80107cae,(%esp)
80103991:	e8 4a e5 ff ff       	call   80101ee0 <namei>
80103996:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103999:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
801039a0:	e8 ab 10 00 00       	call   80104a50 <acquire>
  p->state = RUNNABLE;
801039a5:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
801039ac:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
801039b3:	e8 58 11 00 00       	call   80104b10 <release>
}
...
801039c3:	68 8c 7c 10 80       	push   $0x80107c8c
...
801039d5:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
801039d8:	e8 a3 0f 00 00       	call   80104980 <pushcli>
  c = mycpu();
801039dd:	e8 2e fe ff ff       	call   80103810 <mycpu>
  p = c->proc;
801039e2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039e8:	e8 d3 0f 00 00       	call   801049c0 <popcli>
  if(n > 0){
...
801039fc:	e8 3f 36 00 00       	call   80107040 <switchuvm>
  return 0;
...
80103a1a:	e8 71 38 00 00       	call   80107290 <allocuvm>
...
80103a3a:	e8 81 39 00 00       	call   801073c0 <deallocuvm>
...
80103a56:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103a59:	e8 22 0f 00 00       	call   80104980 <pushcli>
  c = mycpu();
80103a5e:	e8 ad fd ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103a63:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a69:	e8 52 0f 00 00       	call   801049c0 <popcli>
  if((np = allocproc()) == 0){
...
80103a88:	e8 b3 3a 00 00       	call   80107540 <copyuvm>
...
80103b01:	e8 3a 12 00 00       	call   80104d40 <safestrcpy>
  pid = np->pid;
80103b06:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103b09:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
80103b10:	e8 3b 0f 00 00       	call   80104a50 <acquire>
  np->state = RUNNABLE;
80103b15:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103b1c:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
80103b23:	e8 e8 0f 00 00       	call   80104b10 <release>
  return pid;
...
80103b8e:	83 ec 0c             	sub    $0xc,%esp
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103b91:	bf 94 45 11 80       	mov    $0x80114594,%edi
      acquire(&ptable.lock);
80103b96:	68 60 45 11 80       	push   $0x80114560
80103b9b:	e8 b0 0e 00 00       	call   80104a50 <acquire>
80103ba0:	83 c4 10             	add    $0x10,%esp
80103ba3:	eb 15                	jmp    80103bba <scheduler+0x4a>
80103ba5:	8d 76 00             	lea    0x0(%esi),%esi
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ba8:	81 c7 b0 00 00 00    	add    $0xb0,%edi
80103bae:	81 ff 94 71 11 80    	cmp    $0x80117194,%edi
80103bb4:	0f 83 8d 00 00 00    	jae    80103c47 <scheduler+0xd7>
        if(p->state != RUNNABLE)
80103bba:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103bbe:	75 e8                	jne    80103ba8 <scheduler+0x38>
        for(pq = ptable.proc; pq < &ptable.proc[NPROC]; pq++) {
80103bc0:	b8 94 45 11 80       	mov    $0x80114594,%eax
80103bc5:	8d 76 00             	lea    0x0(%esi),%esi
          if(pq->state == RUNNABLE && pq->priority < minProc->priority) {
80103bc8:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103bcc:	75 0f                	jne    80103bdd <scheduler+0x6d>
80103bce:	8b 97 8c 00 00 00    	mov    0x8c(%edi),%edx
80103bd4:	39 90 8c 00 00 00    	cmp    %edx,0x8c(%eax)
80103bda:	0f 4c f8             	cmovl  %eax,%edi
        for(pq = ptable.proc; pq < &ptable.proc[NPROC]; pq++) {
80103bdd:	05 b0 00 00 00       	add    $0xb0,%eax
80103be2:	3d 94 71 11 80       	cmp    $0x80117194,%eax
80103be7:	72 df                	jb     80103bc8 <scheduler+0x58>
          cprintf("%d ** %d\n", c->apicid, p->pid);
80103be9:	83 ec 04             	sub    $0x4,%esp
80103bec:	ff 77 10             	pushl  0x10(%edi)
80103bef:	0f b6 03             	movzbl (%ebx),%eax
80103bf2:	50                   	push   %eax
80103bf3:	68 b0 7c 10 80       	push   $0x80107cb0
80103bf8:	e8 63 ca ff ff       	call   80100660 <cprintf>
          c->proc = p;
80103bfd:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
          switchuvm(p);
80103c03:	89 3c 24             	mov    %edi,(%esp)
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c06:	81 c7 b0 00 00 00    	add    $0xb0,%edi
          switchuvm(p);
80103c0c:	e8 2f 34 00 00       	call   80107040 <switchuvm>
          p->state = RUNNING;
80103c11:	c7 87 5c ff ff ff 04 	movl   $0x4,-0xa4(%edi)
80103c18:	00 00 00 
          swtch(&(c->scheduler), p->context);
80103c1b:	58                   	pop    %eax
80103c1c:	5a                   	pop    %edx
80103c1d:	ff b7 6c ff ff ff    	pushl  -0x94(%edi)
80103c23:	56                   	push   %esi
80103c24:	e8 72 11 00 00       	call   80104d9b <swtch>
          switchkvm();
80103c29:	e8 f2 33 00 00       	call   80107020 <switchkvm>
          c->proc = 0;
80103c2e:	83 c4 10             	add    $0x10,%esp
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c31:	81 ff 94 71 11 80    	cmp    $0x80117194,%edi
          c->proc = 0;
80103c37:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103c3e:	00 00 00 
      for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c41:	0f 82 73 ff ff ff    	jb     80103bba <scheduler+0x4a>
      release(&ptable.lock);
80103c47:	83 ec 0c             	sub    $0xc,%esp
80103c4a:	68 60 45 11 80       	push   $0x80114560
80103c4f:	e8 bc 0e 00 00       	call   80104b10 <release>
    for(;;){
80103c54:	83 c4 10             	add    $0x10,%esp
80103c57:	e9 31 ff ff ff       	jmp    80103b8d <scheduler+0x1d>
...
80103c64:	53                   	push   %ebx
  pushcli();
80103c65:	e8 16 0d 00 00       	call   80104980 <pushcli>
  c = mycpu();
80103c6a:	e8 a1 fb ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103c6f:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103c75:	e8 46 0d 00 00       	call   801049c0 <popcli>
  if(!holding(&ptable.lock))
80103c7a:	83 ec 0c             	sub    $0xc,%esp
80103c7d:	68 60 45 11 80       	push   $0x80114560
80103c82:	e8 99 0d 00 00       	call   80104a20 <holding>
80103c87:	83 c4 10             	add    $0x10,%esp
80103c8a:	85 c0                	test   %eax,%eax
80103c8c:	74 4f                	je     80103cdd <sched+0x7d>
  if(mycpu()->ncli != 1)
80103c8e:	e8 7d fb ff ff       	call   80103810 <mycpu>
...
80103ca7:	75 41                	jne    80103cea <sched+0x8a>
  intena = mycpu()->intena;
80103ca9:	e8 62 fb ff ff       	call   80103810 <mycpu>
  swtch(&p->context, mycpu()->scheduler);
80103cae:	83 c3 1c             	add    $0x1c,%ebx
  intena = mycpu()->intena;
80103cb1:	8b b0 a8 00 00 00    	mov    0xa8(%eax),%esi
  swtch(&p->context, mycpu()->scheduler);
80103cb7:	e8 54 fb ff ff       	call   80103810 <mycpu>
80103cbc:	83 ec 08             	sub    $0x8,%esp
80103cbf:	ff 70 04             	pushl  0x4(%eax)
80103cc2:	53                   	push   %ebx
80103cc3:	e8 d3 10 00 00       	call   80104d9b <swtch>
  mycpu()->intena = intena;
80103cc8:	e8 43 fb ff ff       	call   80103810 <mycpu>
}
...
80103d26:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d29:	e8 52 0c 00 00       	call   80104980 <pushcli>
  c = mycpu();
80103d2e:	e8 dd fa ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103d33:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103d39:	e8 82 0c 00 00       	call   801049c0 <popcli>
  if(curproc == initproc)
80103d3e:	39 35 b8 b5 10 80    	cmp    %esi,0x8010b5b8
...
80103d6d:	75 e1                	jne    80103d50 <exit+0x30>
  begin_op();
80103d6f:	e8 2c ee ff ff       	call   80102ba0 <begin_op>
  iput(curproc->cwd);
80103d74:	83 ec 0c             	sub    $0xc,%esp
80103d77:	ff 76 68             	pushl  0x68(%esi)
80103d7a:	e8 31 da ff ff       	call   801017b0 <iput>
  end_op();
80103d7f:	e8 8c ee ff ff       	call   80102c10 <end_op>
  curproc->cwd = 0;
80103d84:	c7 46 68 00 00 00 00 	movl   $0x0,0x68(%esi)
  acquire(&ptable.lock);
80103d8b:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
80103d92:	e8 b9 0c 00 00       	call   80104a50 <acquire>
...
80103dcb:	3d 94 71 11 80       	cmp    $0x80117194,%eax
80103dd0:	72 e2                	jb     80103db4 <exit+0x94>
      pq->parent = initproc;
80103dd2:	8b 0d b8 b5 10 80    	mov    0x8010b5b8,%ecx
  for(pq = ptable.proc; pq < &ptable.proc[NPROC]; pq++){
80103dd8:	ba 94 45 11 80       	mov    $0x80114594,%edx
80103ddd:	eb 0f                	jmp    80103dee <exit+0xce>
80103ddf:	90                   	nop
80103de0:	81 c2 b0 00 00 00    	add    $0xb0,%edx
80103de6:	81 fa 94 71 11 80    	cmp    $0x80117194,%edx
...
80103e28:	a1 e0 79 11 80       	mov    0x801179e0,%eax
  curproc->state = ZOMBIE;
80103e2d:	c7 46 0c 05 00 00 00 	movl   $0x5,0xc(%esi)
  curproc->endTime = ticks;
80103e34:	89 86 84 00 00 00    	mov    %eax,0x84(%esi)
  sched();
80103e3a:	e8 21 fe ff ff       	call   80103c60 <sched>
  panic("zombie exit");
80103e3f:	83 ec 0c             	sub    $0xc,%esp
80103e42:	68 07 7d 10 80       	push   $0x80107d07
80103e47:	e8 44 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e4c:	83 ec 0c             	sub    $0xc,%esp
80103e4f:	68 fa 7c 10 80       	push   $0x80107cfa
...
80103e67:	68 60 45 11 80       	push   $0x80114560
80103e6c:	e8 df 0b 00 00       	call   80104a50 <acquire>
  pushcli();
80103e71:	e8 0a 0b 00 00       	call   80104980 <pushcli>
  c = mycpu();
80103e76:	e8 95 f9 ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103e7b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e81:	e8 3a 0b 00 00       	call   801049c0 <popcli>
  myproc()->state = RUNNABLE;
80103e86:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  cprintf("Yield called\n");
80103e8d:	c7 04 24 13 7d 10 80 	movl   $0x80107d13,(%esp)
80103e94:	e8 c7 c7 ff ff       	call   80100660 <cprintf>
  sched();
80103e99:	e8 c2 fd ff ff       	call   80103c60 <sched>
  release(&ptable.lock);
80103e9e:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
80103ea5:	e8 66 0c 00 00       	call   80104b10 <release>
}
...
80103ecc:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103ecf:	e8 ac 0a 00 00       	call   80104980 <pushcli>
  c = mycpu();
80103ed4:	e8 37 f9 ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103ed9:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103edf:	e8 dc 0a 00 00       	call   801049c0 <popcli>
  if(p == 0)
...
80103ef0:	81 fe 60 45 11 80    	cmp    $0x80114560,%esi
80103ef6:	74 50                	je     80103f48 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103ef8:	83 ec 0c             	sub    $0xc,%esp
80103efb:	68 60 45 11 80       	push   $0x80114560
80103f00:	e8 4b 0b 00 00       	call   80104a50 <acquire>
    release(lk);
80103f05:	89 34 24             	mov    %esi,(%esp)
80103f08:	e8 03 0c 00 00       	call   80104b10 <release>
  p->chan = chan;
80103f0d:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103f10:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f17:	e8 44 fd ff ff       	call   80103c60 <sched>
  p->chan = 0;
80103f1c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103f23:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
80103f2a:	e8 e1 0b 00 00       	call   80104b10 <release>
    acquire(lk);
...
80103f3b:	5d                   	pop    %ebp
    acquire(lk);
80103f3c:	e9 0f 0b 00 00       	jmp    80104a50 <acquire>
...
80103f4b:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f52:	e8 09 fd ff ff       	call   80103c60 <sched>
  p->chan = 0;
...
80103f69:	68 27 7d 10 80       	push   $0x80107d27
80103f6e:	e8 1d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f73:	83 ec 0c             	sub    $0xc,%esp
80103f76:	68 21 7d 10 80       	push   $0x80107d21
...
80103f84:	53                   	push   %ebx
  pushcli();
80103f85:	e8 f6 09 00 00       	call   80104980 <pushcli>
  c = mycpu();
80103f8a:	e8 81 f8 ff ff       	call   80103810 <mycpu>
  p = c->proc;
80103f8f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103f95:	e8 26 0a 00 00       	call   801049c0 <popcli>
  acquire(&ptable.lock);
80103f9a:	83 ec 0c             	sub    $0xc,%esp
80103f9d:	68 60 45 11 80       	push   $0x80114560
80103fa2:	e8 a9 0a 00 00       	call   80104a50 <acquire>
80103fa7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
80103faa:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fac:	bb 94 45 11 80       	mov    $0x80114594,%ebx
80103fb1:	eb 13                	jmp    80103fc6 <wait+0x46>
80103fb3:	90                   	nop
80103fb4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103fb8:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103fbe:	81 fb 94 71 11 80    	cmp    $0x80117194,%ebx
...
80103fcf:	74 37                	je     80104008 <wait+0x88>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fd1:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
      havekids = 1;
80103fd7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103fdc:	81 fb 94 71 11 80    	cmp    $0x80117194,%ebx
...
80103ff2:	68 60 45 11 80       	push   $0x80114560
...
8010400e:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104011:	e8 fa e2 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
80104016:	5a                   	pop    %edx
...
8010401a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104021:	e8 ca 33 00 00       	call   801073f0 <freevm>
        release(&ptable.lock);
80104026:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
        p->pid = 0;
...
80104046:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
8010404d:	e8 be 0a 00 00       	call   80104b10 <release>
        return pid;
...
80104061:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104066:	68 60 45 11 80       	push   $0x80114560
8010406b:	e8 a0 0a 00 00       	call   80104b10 <release>
      return -1;
...
80104084:	53                   	push   %ebx
  pushcli();
80104085:	e8 f6 08 00 00       	call   80104980 <pushcli>
  c = mycpu();
8010408a:	e8 81 f7 ff ff       	call   80103810 <mycpu>
  p = c->proc;
8010408f:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80104095:	e8 26 09 00 00       	call   801049c0 <popcli>
  acquire(&ptable.lock);
8010409a:	83 ec 0c             	sub    $0xc,%esp
8010409d:	68 60 45 11 80       	push   $0x80114560
801040a2:	e8 a9 09 00 00       	call   80104a50 <acquire>
801040a7:	83 c4 10             	add    $0x10,%esp
    havekids = 0;
801040aa:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040ac:	bb 94 45 11 80       	mov    $0x80114594,%ebx
801040b1:	eb 13                	jmp    801040c6 <waitx+0x46>
801040b3:	90                   	nop
801040b4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801040b8:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801040be:	81 fb 94 71 11 80    	cmp    $0x80117194,%ebx
801040c4:	73 1e                	jae    801040e4 <waitx+0x64>
      if(p->parent != curproc)
801040c6:	39 73 14             	cmp    %esi,0x14(%ebx)
801040c9:	75 ed                	jne    801040b8 <waitx+0x38>
      if(p->state == ZOMBIE){
801040cb:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
801040cf:	74 3f                	je     80104110 <waitx+0x90>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040d1:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
      havekids = 1;
801040d7:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801040dc:	81 fb 94 71 11 80    	cmp    $0x80117194,%ebx
801040e2:	72 e2                	jb     801040c6 <waitx+0x46>
    if(!havekids || curproc->killed){
801040e4:	85 c0                	test   %eax,%eax
801040e6:	0f 84 99 00 00 00    	je     80104185 <waitx+0x105>
801040ec:	8b 46 24             	mov    0x24(%esi),%eax
801040ef:	85 c0                	test   %eax,%eax
801040f1:	0f 85 8e 00 00 00    	jne    80104185 <waitx+0x105>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
801040f7:	83 ec 08             	sub    $0x8,%esp
801040fa:	68 60 45 11 80       	push   $0x80114560
801040ff:	56                   	push   %esi
80104100:	e8 bb fd ff ff       	call   80103ec0 <sleep>
    havekids = 0;
80104105:	83 c4 10             	add    $0x10,%esp
80104108:	eb a0                	jmp    801040aa <waitx+0x2a>
8010410a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        kfree(p->kstack);
80104110:	83 ec 0c             	sub    $0xc,%esp
80104113:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80104116:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104119:	e8 f2 e1 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
8010411e:	5a                   	pop    %edx
...
80104122:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104129:	e8 c2 32 00 00       	call   801073f0 <freevm>
        *rtime = p->runTime;
8010412e:	8b 93 80 00 00 00    	mov    0x80(%ebx),%edx
...
80104159:	8b 93 84 00 00 00    	mov    0x84(%ebx),%edx
8010415f:	2b 53 7c             	sub    0x7c(%ebx),%edx
80104162:	2b 93 80 00 00 00    	sub    0x80(%ebx),%edx
80104168:	8b 45 08             	mov    0x8(%ebp),%eax
8010416b:	89 10                	mov    %edx,(%eax)
        release(&ptable.lock);
8010416d:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
80104174:	e8 97 09 00 00       	call   80104b10 <release>
        return pid;
...
80104185:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104188:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010418d:	68 60 45 11 80       	push   $0x80114560
80104192:	e8 79 09 00 00       	call   80104b10 <release>
      return -1;
80104197:	83 c4 10             	add    $0x10,%esp
8010419a:	eb e0                	jmp    8010417c <waitx+0xfc>
...
801041a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
801041aa:	68 60 45 11 80       	push   $0x80114560
801041af:	e8 9c 08 00 00       	call   80104a50 <acquire>
801041b4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041b7:	b8 94 45 11 80       	mov    $0x80114594,%eax
801041bc:	eb 0e                	jmp    801041cc <wakeup+0x2c>
801041be:	66 90                	xchg   %ax,%ax
801041c0:	05 b0 00 00 00       	add    $0xb0,%eax
801041c5:	3d 94 71 11 80       	cmp    $0x80117194,%eax
...
801041d7:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041de:	05 b0 00 00 00       	add    $0xb0,%eax
801041e3:	3d 94 71 11 80       	cmp    $0x80117194,%eax
801041e8:	72 e2                	jb     801041cc <wakeup+0x2c>
  wakeup1(chan);
  release(&ptable.lock);
801041ea:	c7 45 08 60 45 11 80 	movl   $0x80114560,0x8(%ebp)
}
801041f1:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801041f4:	c9                   	leave  
  release(&ptable.lock);
801041f5:	e9 16 09 00 00       	jmp    80104b10 <release>
...
80104207:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010420a:	68 60 45 11 80       	push   $0x80114560
8010420f:	e8 3c 08 00 00       	call   80104a50 <acquire>
80104214:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104217:	b8 94 45 11 80       	mov    $0x80114594,%eax
8010421c:	eb 0e                	jmp    8010422c <kill+0x2c>
8010421e:	66 90                	xchg   %ax,%ax
80104220:	05 b0 00 00 00       	add    $0xb0,%eax
80104225:	3d 94 71 11 80       	cmp    $0x80117194,%eax
...
80104248:	68 60 45 11 80       	push   $0x80114560
8010424d:	e8 be 08 00 00       	call   80104b10 <release>
      return 0;
...
80104263:	68 60 45 11 80       	push   $0x80114560
80104268:	e8 a3 08 00 00       	call   80104b10 <release>
  return -1;
...
80104286:	8d 75 e8             	lea    -0x18(%ebp),%esi
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104289:	bb 94 45 11 80       	mov    $0x80114594,%ebx
{
...
8010429b:	68 57 7d 10 80       	push   $0x80107d57
801042a0:	e8 bb c3 ff ff       	call   80100660 <cprintf>
801042a5:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801042a8:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
801042ae:	81 fb 94 71 11 80    	cmp    $0x80117194,%ebx
...
801042c1:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
801042c4:	ba 38 7d 10 80       	mov    $0x80107d38,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
801042c9:	77 11                	ja     801042dc <procdump+0x5c>
801042cb:	8b 14 85 04 7e 10 80 	mov    -0x7fef81fc(,%eax,4),%edx
      state = "???";
801042d2:	b8 38 7d 10 80       	mov    $0x80107d38,%eax
...
801042e4:	68 3c 7d 10 80       	push   $0x80107d3c
...
8010430b:	e8 20 06 00 00       	call   80104930 <getcallerpcs>
...
80104329:	68 61 77 10 80       	push   $0x80107761
...
80104353:	83 ec 14             	sub    $0x14,%esp
  ...
  //   }
  acquire(&ptable.lock);
80104356:	68 60 45 11 80       	push   $0x80114560
8010435b:	e8 f0 06 00 00       	call   80104a50 <acquire>
80104360:	83 c4 10             	add    $0x10,%esp
  struct proc *p;
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104363:	b8 94 45 11 80       	mov    $0x80114594,%eax
80104368:	eb 19                	jmp    80104383 <update_proc_time+0x33>
8010436a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  	...
  	{	
      p->wait_queue_time++;
80104370:	83 80 88 00 00 00 01 	addl   $0x1,0x88(%eax)
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104377:	05 b0 00 00 00       	add    $0xb0,%eax
8010437c:	3d 94 71 11 80       	cmp    $0x80117194,%eax
80104381:	73 19                	jae    8010439c <update_proc_time+0x4c>
  	if(p->state == RUNNING){	
80104383:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80104387:	75 e7                	jne    80104370 <update_proc_time+0x20>
      p->runTime++;
80104389:	83 80 80 00 00 00 01 	addl   $0x1,0x80(%eax)
	for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104390:	05 b0 00 00 00       	add    $0xb0,%eax
80104395:	3d 94 71 11 80       	cmp    $0x80117194,%eax
8010439a:	72 e7                	jb     80104383 <update_proc_time+0x33>
        cprintf("AGING %d\n", p->pid);
      }
      #endif
    }  
...
8010439f:	68 60 45 11 80       	push   $0x80114560
801043a4:	e8 67 07 00 00       	call   80104b10 <release>
}
...
801043b7:	8b 5d 0c             	mov    0xc(%ebp),%ebx
  struct proc* p;
  int prev_priority = -1;
  acquire(&ptable.lock);
801043ba:	68 60 45 11 80       	push   $0x80114560
801043bf:	e8 8c 06 00 00       	call   80104a50 <acquire>
801043c4:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801043c7:	ba 94 45 11 80       	mov    $0x80114594,%edx
801043cc:	eb 10                	jmp    801043de <set_priority+0x2e>
801043ce:	66 90                	xchg   %ax,%ax
801043d0:	81 c2 b0 00 00 00    	add    $0xb0,%edx
801043d6:	81 fa 94 71 11 80    	cmp    $0x80117194,%edx
801043dc:	73 32                	jae    80104410 <set_priority+0x60>
    if(p->pid == pid){
801043de:	39 5a 10             	cmp    %ebx,0x10(%edx)
801043e1:	75 ed                	jne    801043d0 <set_priority+0x20>
      prev_priority = p->priority;
      p->priority = new_priority;
801043e3:	8b 45 08             	mov    0x8(%ebp),%eax
      prev_priority = p->priority;
801043e6:	8b 9a 8c 00 00 00    	mov    0x8c(%edx),%ebx
      p->priority = new_priority;
801043ec:	89 82 8c 00 00 00    	mov    %eax,0x8c(%edx)
      break; 
    }
  }
  release(&ptable.lock);
801043f2:	83 ec 0c             	sub    $0xc,%esp
801043f5:	68 60 45 11 80       	push   $0x80114560
801043fa:	e8 11 07 00 00       	call   80104b10 <release>
...
80104409:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  int prev_priority = -1;
80104410:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
80104415:	eb db                	jmp    801043f2 <set_priority+0x42>
...
80104427:	8b 0c 85 c0 c5 10 80 	mov    -0x7fef3a40(,%eax,4),%ecx
8010442e:	8b 14 85 6c 0f 11 80 	mov    -0x7feef094(,%eax,4),%edx
80104435:	b8 01 00 00 00       	mov    $0x1,%eax
8010443a:	8d 59 01             	lea    0x1(%ecx),%ebx
8010443d:	39 da                	cmp    %ebx,%edx
8010443f:	74 0f                	je     80104450 <isFull+0x30>
80104441:	83 f9 63             	cmp    $0x63,%ecx
80104444:	0f 94 c1             	sete   %cl
80104447:	31 c0                	xor    %eax,%eax
80104449:	85 d2                	test   %edx,%edx
8010444b:	0f 94 c0             	sete   %al
8010444e:	21 c8                	and    %ecx,%eax
    return 0;
}
80104450:	5b                   	pop    %ebx
80104451:	5d                   	pop    %ebp
...
80104466:	5d                   	pop    %ebp
    if(front[num] == -1) return 1;
80104467:	83 3c 85 6c 0f 11 80 	cmpl   $0xffffffff,-0x7feef094(,%eax,4)
8010446e:	ff 
8010446f:	0f 94 c0             	sete   %al
80104472:	0f b6 c0             	movzbl %al,%eax
}
80104475:	c3                   	ret    
...
80104481:	31 c9                	xor    %ecx,%ecx
80104483:	89 e5                	mov    %esp,%ebp
80104485:	57                   	push   %edi
80104486:	56                   	push   %esi
80104487:	53                   	push   %ebx

    for(int i = 0; i < 5; i++)
80104488:	31 ff                	xor    %edi,%edi
{
8010448a:	83 ec 1c             	sub    $0x1c,%esp
8010448d:	8b 45 08             	mov    0x8(%ebp),%eax
80104490:	8b 5d 0c             	mov    0xc(%ebp),%ebx
80104493:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    {
      if(front[i] <= rear[i])
80104496:	8b 14 bd 6c 0f 11 80 	mov    -0x7feef094(,%edi,4),%edx
8010449d:	8b 34 bd c0 c5 10 80 	mov    -0x7fef3a40(,%edi,4),%esi
801044a4:	39 f2                	cmp    %esi,%edx
801044a6:	0f 8f c4 00 00 00    	jg     80104570 <enQueue+0xf0>
      {
        for(int j = front[i]; j>=0 && j <= rear[i]; j++)
801044ac:	85 d2                	test   %edx,%edx
801044ae:	78 2c                	js     801044dc <enQueue+0x5c>
        {
          if(element == q[i][j])
801044b0:	6b c7 64             	imul   $0x64,%edi,%eax
801044b3:	01 d0                	add    %edx,%eax
801044b5:	3b 1c 85 80 0f 11 80 	cmp    -0x7feef080(,%eax,4),%ebx
801044bc:	75 17                	jne    801044d5 <enQueue+0x55>
801044be:	e9 a3 00 00 00       	jmp    80104566 <enQueue+0xe6>
801044c3:	90                   	nop
801044c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801044c8:	39 9c 91 80 0f 11 80 	cmp    %ebx,-0x7feef080(%ecx,%edx,4)
801044cf:	0f 84 91 00 00 00    	je     80104566 <enQueue+0xe6>
        for(int j = front[i]; j>=0 && j <= rear[i]; j++)
801044d5:	83 c2 01             	add    $0x1,%edx
801044d8:	39 d6                	cmp    %edx,%esi
801044da:	7d ec                	jge    801044c8 <enQueue+0x48>
    for(int i = 0; i < 5; i++)
801044dc:	83 c7 01             	add    $0x1,%edi
801044df:	81 c1 90 01 00 00    	add    $0x190,%ecx
801044e5:	83 ff 05             	cmp    $0x5,%edi
801044e8:	75 ac                	jne    80104496 <enQueue+0x16>
    if( (front[num] == rear[num] + 1) || (front[num] == 0 && rear[num] == 99)) return 1;
801044ea:	8b 7d e4             	mov    -0x1c(%ebp),%edi
801044ed:	8b 14 bd c0 c5 10 80 	mov    -0x7fef3a40(,%edi,4),%edx
801044f4:	8b 04 bd 6c 0f 11 80 	mov    -0x7feef094(,%edi,4),%eax
801044fb:	8d 4a 01             	lea    0x1(%edx),%ecx
801044fe:	39 c8                	cmp    %ecx,%eax
80104500:	0f 84 b9 00 00 00    	je     801045bf <enQueue+0x13f>
80104506:	85 c0                	test   %eax,%eax
80104508:	0f 84 92 00 00 00    	je     801045a0 <enQueue+0x120>
    // {
      ...
      else
      {
          // cprintf("inserted %d\n", element->pid);
          qSize[num]++;
8010450e:	8b 7d e4             	mov    -0x1c(%ebp),%edi
          element -> curTime = 0;
80104511:	c7 83 a8 00 00 00 00 	movl   $0x0,0xa8(%ebx)
80104518:	00 00 00 
          qSize[num]++;
8010451b:	83 04 bd d4 c5 10 80 	addl   $0x1,-0x7fef3a2c(,%edi,4)
80104522:	01 
          if(front[num] == -1) front[num] = 0;
80104523:	83 f8 ff             	cmp    $0xffffffff,%eax
80104526:	75 0e                	jne    80104536 <enQueue+0xb6>
80104528:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010452b:	c7 04 85 6c 0f 11 80 	movl   $0x0,-0x7feef094(,%eax,4)
80104532:	00 00 00 00 
          rear[num] = (rear[num] + 1) % 100;
80104536:	89 c8                	mov    %ecx,%eax
80104538:	ba 1f 85 eb 51       	mov    $0x51eb851f,%edx
8010453d:	f7 ea                	imul   %edx
8010453f:	89 c8                	mov    %ecx,%eax
80104541:	c1 f8 1f             	sar    $0x1f,%eax
80104544:	c1 fa 05             	sar    $0x5,%edx
80104547:	29 c2                	sub    %eax,%edx
80104549:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010454c:	6b d2 64             	imul   $0x64,%edx,%edx
8010454f:	29 d1                	sub    %edx,%ecx
80104551:	89 0c 85 c0 c5 10 80 	mov    %ecx,-0x7fef3a40(,%eax,4)
80104558:	89 ca                	mov    %ecx,%edx
          q[num][rear[num]] = element;
8010455a:	6b c0 64             	imul   $0x64,%eax,%eax
8010455d:	01 c2                	add    %eax,%edx
8010455f:	89 1c 95 80 0f 11 80 	mov    %ebx,-0x7feef080(,%edx,4)
      }
    // }
}
80104566:	83 c4 1c             	add    $0x1c,%esp
80104569:	5b                   	pop    %ebx
8010456a:	5e                   	pop    %esi
8010456b:	5f                   	pop    %edi
8010456c:	5d                   	pop    %ebp
...
80104572:	eb 10                	jmp    80104584 <enQueue+0x104>
80104574:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104578:	83 c0 01             	add    $0x1,%eax
8010457b:	83 f8 64             	cmp    $0x64,%eax
8010457e:	0f 84 58 ff ff ff    	je     801044dc <enQueue+0x5c>
          if(j <= rear[i] || j >= front[i])
80104584:	39 c2                	cmp    %eax,%edx
80104586:	7e 04                	jle    8010458c <enQueue+0x10c>
80104588:	39 c6                	cmp    %eax,%esi
8010458a:	7c ec                	jl     80104578 <enQueue+0xf8>
            if(element == q[i][j])
8010458c:	39 9c 81 80 0f 11 80 	cmp    %ebx,-0x7feef080(%ecx,%eax,4)
80104593:	75 e3                	jne    80104578 <enQueue+0xf8>
}
80104595:	83 c4 1c             	add    $0x1c,%esp
80104598:	5b                   	pop    %ebx
80104599:	5e                   	pop    %esi
8010459a:	5f                   	pop    %edi
8010459b:	5d                   	pop    %ebp
...
8010459d:	8d 76 00             	lea    0x0(%esi),%esi
    if( (front[num] == rear[num] + 1) || (front[num] == 0 && rear[num] == 99)) return 1;
801045a0:	83 fa 63             	cmp    $0x63,%edx
801045a3:	74 1a                	je     801045bf <enQueue+0x13f>
          qSize[num]++;
801045a5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
          element -> curTime = 0;
801045a8:	c7 83 a8 00 00 00 00 	movl   $0x0,0xa8(%ebx)
801045af:	00 00 00 
          qSize[num]++;
801045b2:	83 04 85 d4 c5 10 80 	addl   $0x1,-0x7fef3a2c(,%eax,4)
801045b9:	01 
801045ba:	e9 77 ff ff ff       	jmp    80104536 <enQueue+0xb6>
      if(isFull(num)) cprintf("\n Queue is full!! \n");
801045bf:	c7 45 08 45 7d 10 80 	movl   $0x80107d45,0x8(%ebp)
}
801045c6:	83 c4 1c             	add    $0x1c,%esp
801045c9:	5b                   	pop    %ebx
801045ca:	5e                   	pop    %esi
801045cb:	5f                   	pop    %edi
801045cc:	5d                   	pop    %ebp
      if(isFull(num)) cprintf("\n Queue is full!! \n");
801045cd:	e9 8e c0 ff ff       	jmp    80100660 <cprintf>
...
801045e8:	8b 0c 9d 6c 0f 11 80 	mov    -0x7feef094(,%ebx,4),%ecx
    qSize[num]--;
801045ef:	83 2c 9d d4 c5 10 80 	subl   $0x1,-0x7fef3a2c(,%ebx,4)
801045f6:	01 
    element = q[num][front[num]];
801045f7:	6b c3 64             	imul   $0x64,%ebx,%eax
801045fa:	01 c8                	add    %ecx,%eax
    if (front[num] == rear[num]){
801045fc:	3b 0c 9d c0 c5 10 80 	cmp    -0x7fef3a40(,%ebx,4),%ecx
    element = q[num][front[num]];
80104603:	8b 34 85 80 0f 11 80 	mov    -0x7feef080(,%eax,4),%esi
    if (front[num] == rear[num]){
8010460a:	74 2c                	je     80104638 <deQueue+0x58>
        front[num] = -1;
        rear[num] = -1;
    } /* Q has only one element, so we reset the queue after dequeing it. ? */
    else {
        front[num] = (front[num] + 1) % 100;
8010460c:	83 c1 01             	add    $0x1,%ecx
8010460f:	ba 1f 85 eb 51       	mov    $0x51eb851f,%edx
80104614:	89 c8                	mov    %ecx,%eax
80104616:	f7 ea                	imul   %edx
80104618:	89 c8                	mov    %ecx,%eax
8010461a:	c1 f8 1f             	sar    $0x1f,%eax
8010461d:	c1 fa 05             	sar    $0x5,%edx
80104620:	29 c2                	sub    %eax,%edx
    }
    // // cprintf("\n Deleted %d\n", element->pid);
    return element;
}
80104622:	89 f0                	mov    %esi,%eax
        front[num] = (front[num] + 1) % 100;
80104624:	6b d2 64             	imul   $0x64,%edx,%edx
80104627:	29 d1                	sub    %edx,%ecx
80104629:	89 0c 9d 6c 0f 11 80 	mov    %ecx,-0x7feef094(,%ebx,4)
}
80104630:	5b                   	pop    %ebx
80104631:	5e                   	pop    %esi
80104632:	5d                   	pop    %ebp
...
80104638:	89 f0                	mov    %esi,%eax
        front[num] = -1;
8010463a:	c7 04 9d 6c 0f 11 80 	movl   $0xffffffff,-0x7feef094(,%ebx,4)
80104641:	ff ff ff ff 
        rear[num] = -1;
80104645:	c7 04 9d c0 c5 10 80 	movl   $0xffffffff,-0x7fef3a40(,%ebx,4)
8010464c:	ff ff ff ff 
}
80104650:	5b                   	pop    %ebx
80104651:	5e                   	pop    %esi
80104652:	5d                   	pop    %ebp
...
8010466e:	68 60 45 11 80       	push   $0x80114560
80104673:	e8 d8 03 00 00       	call   80104a50 <acquire>
80104678:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010467b:	b8 94 45 11 80       	mov    $0x80114594,%eax
80104680:	eb 12                	jmp    80104694 <getpinfo+0x34>
80104682:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104688:	05 b0 00 00 00       	add    $0xb0,%eax
8010468d:	3d 94 71 11 80       	cmp    $0x80117194,%eax
80104692:	73 6c                	jae    80104700 <getpinfo+0xa0>
    if(p->pid == pid)
80104694:	39 58 10             	cmp    %ebx,0x10(%eax)
80104697:	75 ef                	jne    80104688 <getpinfo+0x28>
    {
      pinfo_p->pid = p->pid;
80104699:	89 1e                	mov    %ebx,(%esi)
      pinfo_p->runtime = p->runTime;
8010469b:	8b 90 80 00 00 00    	mov    0x80(%eax),%edx
...
801046a1:	83 ec 0c             	sub    $0xc,%esp
      pinfo_p->runtime = p->runTime;
801046a4:	89 56 04             	mov    %edx,0x4(%esi)
      pinfo_p->num_run = p->num_run;
801046a7:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801046ad:	89 56 08             	mov    %edx,0x8(%esi)
      pinfo_p->current_queue = p->queue;
801046b0:	8b 90 90 00 00 00    	mov    0x90(%eax),%edx
801046b6:	89 56 0c             	mov    %edx,0xc(%esi)
        pinfo_p->ticks[i] = p->time[i]; 
801046b9:	8b 90 94 00 00 00    	mov    0x94(%eax),%edx
801046bf:	89 56 10             	mov    %edx,0x10(%esi)
801046c2:	8b 90 98 00 00 00    	mov    0x98(%eax),%edx
801046c8:	89 56 14             	mov    %edx,0x14(%esi)
801046cb:	8b 90 9c 00 00 00    	mov    0x9c(%eax),%edx
801046d1:	89 56 18             	mov    %edx,0x18(%esi)
801046d4:	8b 90 a0 00 00 00    	mov    0xa0(%eax),%edx
801046da:	89 56 1c             	mov    %edx,0x1c(%esi)
801046dd:	8b 80 a4 00 00 00    	mov    0xa4(%eax),%eax
801046e3:	89 46 20             	mov    %eax,0x20(%esi)
      release(&ptable.lock);
801046e6:	68 60 45 11 80       	push   $0x80114560
801046eb:	e8 20 04 00 00       	call   80104b10 <release>
      return 1;
...
801046f3:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return 1;
801046f6:	b8 01 00 00 00       	mov    $0x1,%eax
}
801046fb:	5b                   	pop    %ebx
801046fc:	5e                   	pop    %esi
801046fd:	5d                   	pop    %ebp
...
80104703:	68 60 45 11 80       	push   $0x80114560
...
80104727:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc* p = 0;
  acquire(&ptable.lock);
8010472a:	68 60 45 11 80       	push   $0x80114560
8010472f:	e8 1c 03 00 00       	call   80104a50 <acquire>
80104734:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104737:	b8 94 45 11 80       	mov    $0x80114594,%eax
8010473c:	eb 0e                	jmp    8010474c <higherPriority+0x2c>
8010473e:	66 90                	xchg   %ax,%ax
80104740:	05 b0 00 00 00       	add    $0xb0,%eax
80104745:	3d 94 71 11 80       	cmp    $0x80117194,%eax
8010474a:	73 3c                	jae    80104788 <higherPriority+0x68>
    if(p->priority < cur_proc_priority && p->pid !=0 ) {
8010474c:	8b 90 8c 00 00 00    	mov    0x8c(%eax),%edx
80104752:	39 da                	cmp    %ebx,%edx
80104754:	7d ea                	jge    80104740 <higherPriority+0x20>
80104756:	8b 48 10             	mov    0x10(%eax),%ecx
80104759:	85 c9                	test   %ecx,%ecx
8010475b:	74 e3                	je     80104740 <higherPriority+0x20>
...
80104760:	68 ac 7d 10 80       	push   $0x80107dac
    }
  }
  if(flag) {
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
...
80104765:	e8 f6 be ff ff       	call   80100660 <cprintf>
      release(&ptable.lock);
8010476a:	c7 04 24 60 45 11 80 	movl   $0x80114560,(%esp)
80104771:	e8 9a 03 00 00       	call   80104b10 <release>
      return 1;
80104776:	83 c4 10             	add    $0x10,%esp
80104779:	b8 01 00 00 00       	mov    $0x1,%eax
    }
  }
  }
  release(&ptable.lock);
...
8010478d:	74 36                	je     801047c5 <higherPriority+0xa5>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010478f:	b8 94 45 11 80       	mov    $0x80114594,%eax
80104794:	eb 16                	jmp    801047ac <higherPriority+0x8c>
80104796:	8d 76 00             	lea    0x0(%esi),%esi
80104799:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
801047a0:	05 b0 00 00 00       	add    $0xb0,%eax
801047a5:	3d 94 71 11 80       	cmp    $0x80117194,%eax
801047aa:	73 19                	jae    801047c5 <higherPriority+0xa5>
    if(p->priority == cur_proc_priority && p->pid !=0 ) {
801047ac:	39 98 8c 00 00 00    	cmp    %ebx,0x8c(%eax)
801047b2:	75 ec                	jne    801047a0 <higherPriority+0x80>
801047b4:	8b 50 10             	mov    0x10(%eax),%edx
801047b7:	85 d2                	test   %edx,%edx
801047b9:	74 e5                	je     801047a0 <higherPriority+0x80>
      cprintf("%d Equal priority found  and time slice expired %d %d\n", p->pid, p->priority, cur_proc_priority);
801047bb:	53                   	push   %ebx
801047bc:	53                   	push   %ebx
801047bd:	52                   	push   %edx
801047be:	68 cc 7d 10 80       	push   $0x80107dcc
801047c3:	eb a0                	jmp    80104765 <higherPriority+0x45>
  release(&ptable.lock);
801047c5:	83 ec 0c             	sub    $0xc,%esp
801047c8:	68 60 45 11 80       	push   $0x80114560
801047cd:	e8 3e 03 00 00       	call   80104b10 <release>
  return 0; 
...
801047ea:	68 1c 7e 10 80       	push   $0x80107e1c
...
80104845:	e8 76 f6 ff ff       	call   80103ec0 <sleep>
  while (lk->locked) {
...
80104853:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104859:	e8 52 f0 ff ff       	call   801038b0 <myproc>
...
801048a4:	e8 f7 f8 ff ff       	call   801041a0 <wakeup>
  release(&lk->lk);
...
801048e3:	e8 c8 ef ff ff       	call   801038b0 <myproc>
...
80104989:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010498a:	e8 81 ee ff ff       	call   80103810 <mycpu>
...
8010499f:	e8 6c ee ff ff       	call   80103810 <mycpu>
801049a4:	89 98 a8 00 00 00    	mov    %ebx,0xa8(%eax)
  mycpu()->ncli += 1;
801049aa:	e8 61 ee ff ff       	call   80103810 <mycpu>
...
801049ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801049f0:	e8 1b ee ff ff       	call   80103810 <mycpu>
...
80104a05:	68 27 7e 10 80       	push   $0x80107e27
80104a0a:	e8 81 b9 ff ff       	call   80100390 <panic>
    panic("popcli");
80104a0f:	83 ec 0c             	sub    $0xc,%esp
80104a12:	68 3e 7e 10 80       	push   $0x80107e3e
...
80104a38:	e8 d3 ed ff ff       	call   80103810 <mycpu>
...
80104a94:	e8 77 ed ff ff       	call   80103810 <mycpu>
...
80104af7:	68 45 7e 10 80       	push   $0x80107e45
...
80104b4c:	68 4d 7e 10 80       	push   $0x80107e4d
...
80104db7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104dba:	e8 f1 ea ff ff       	call   801038b0 <myproc>
...
80104df7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
80104dfa:	e8 b1 ea ff ff       	call   801038b0 <myproc>
...
80104e65:	e8 46 ea ff ff       	call   801038b0 <myproc>
...
80104e73:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104e76:	e8 35 ea ff ff       	call   801038b0 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104f54:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104f57:	e8 54 e9 ff ff       	call   801038b0 <myproc>
...
80104f6c:	8b 14 85 80 7e 10 80 	mov    -0x7fef8180(,%eax,4),%edx
...
80104f90:	68 55 7e 10 80       	push   $0x80107e55
...
80104fc7:	89 4d cc             	mov    %ecx,-0x34(%ebp)
  if((dp = nameiparent(path, name)) == 0)
80104fca:	e8 31 cf ff ff       	call   80101f00 <nameiparent>
...
80104fe0:	e8 9b c6 ff ff       	call   80101680 <ilock>
...
80104fec:	e8 bf cb ff ff       	call   80101bb0 <dirlookup>
...
80104ffe:	e8 0d c9 ff ff       	call   80101910 <iunlockput>
    ilock(ip);
80105003:	89 3c 24             	mov    %edi,(%esp)
80105006:	e8 75 c6 ff ff       	call   80101680 <ilock>
...
8010503a:	e8 d1 c4 ff ff       	call   80101510 <ialloc>
...
80105071:	e8 5a c5 ff ff       	call   801015d0 <iupdate>
...
80105088:	e8 93 cd ff ff       	call   80101e20 <dirlink>
...
801050b4:	31 ff                	xor    %edi,%edi
    iunlockput(ip);
801050b6:	e8 55 c8 ff ff       	call   80101910 <iunlockput>
    return 0;
...
801050e4:	68 00 7f 10 80       	push   $0x80107f00
801050e9:	57                   	push   %edi
801050ea:	e8 31 cd ff ff       	call   80101e20 <dirlink>
...
801050fc:	68 ff 7e 10 80       	push   $0x80107eff
80105101:	57                   	push   %edi
80105102:	e8 19 cd ff ff       	call   80101e20 <dirlink>
...
80105115:	68 f3 7e 10 80       	push   $0x80107ef3
...
8010512a:	68 02 7f 10 80       	push   $0x80107f02
8010512f:	e8 5c b2 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80105134:	83 ec 0c             	sub    $0xc,%esp
80105137:	68 e4 7e 10 80       	push   $0x80107ee4
...
80105174:	e8 37 e7 ff ff       	call   801038b0 <myproc>
...
801051b9:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801051bb:	e8 f0 e6 ff ff       	call   801038b0 <myproc>
...
801051e2:	e8 09 bc ff ff       	call   80100df0 <filedup>
  return fd;
...
8010525d:	e8 fe bc ff ff       	call   80100f60 <fileread>
...
801052cd:	e8 1e bd ff ff       	call   80100ff0 <filewrite>
...
80105303:	78 2b                	js     80105330 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80105305:	e8 a6 e5 ff ff       	call   801038b0 <myproc>
...
8010531b:	e8 20 bb ff ff       	call   80100e40 <fileclose>
  return 0;
...
80105374:	e8 97 bb ff ff       	call   80100f10 <filestat>
...
801053c2:	0f 88 e2 00 00 00    	js     801054aa <sys_link+0x11a>
  begin_op();
801053c8:	e8 d3 d7 ff ff       	call   80102ba0 <begin_op>
  if((ip = namei(old)) == 0){
801053cd:	83 ec 0c             	sub    $0xc,%esp
801053d0:	ff 75 d4             	pushl  -0x2c(%ebp)
801053d3:	e8 08 cb ff ff       	call   80101ee0 <namei>
...
801053e9:	e8 92 c2 ff ff       	call   80101680 <ilock>
  if(ip->type == T_DIR){
...
80105408:	e8 c3 c1 ff ff       	call   801015d0 <iupdate>
  iunlock(ip);
8010540d:	89 1c 24             	mov    %ebx,(%esp)
80105410:	e8 4b c3 ff ff       	call   80101760 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105415:	58                   	pop    %eax
80105416:	5a                   	pop    %edx
80105417:	57                   	push   %edi
80105418:	ff 75 d0             	pushl  -0x30(%ebp)
8010541b:	e8 e0 ca ff ff       	call   80101f00 <nameiparent>
...
8010542d:	e8 4e c2 ff ff       	call   80101680 <ilock>
...
80105443:	e8 d8 c9 ff ff       	call   80101e20 <dirlink>
...
80105453:	e8 b8 c4 ff ff       	call   80101910 <iunlockput>
  iput(ip);
80105458:	89 1c 24             	mov    %ebx,(%esp)
8010545b:	e8 50 c3 ff ff       	call   801017b0 <iput>
  end_op();
...
8010547c:	e8 8f c4 ff ff       	call   80101910 <iunlockput>
    goto bad;
80105481:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105484:	83 ec 0c             	sub    $0xc,%esp
80105487:	53                   	push   %ebx
80105488:	e8 f3 c1 ff ff       	call   80101680 <ilock>
  ip->nlink--;
8010548d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105492:	89 1c 24             	mov    %ebx,(%esp)
80105495:	e8 36 c1 ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
8010549a:	89 1c 24             	mov    %ebx,(%esp)
8010549d:	e8 6e c4 ff ff       	call   80101910 <iunlockput>
  end_op();
...
801054bb:	e8 50 c4 ff ff       	call   80101910 <iunlockput>
    end_op();
...
801054cd:	eb 9b                	jmp    8010546a <sys_link+0xda>
    end_op();
801054cf:	e8 3c d7 ff ff       	call   80102c10 <end_op>
    return -1;
...
801054ff:	8d 5d ca             	lea    -0x36(%ebp),%ebx
  begin_op();
80105502:	e8 99 d6 ff ff       	call   80102ba0 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
80105507:	83 ec 08             	sub    $0x8,%esp
8010550a:	53                   	push   %ebx
8010550b:	ff 75 c0             	pushl  -0x40(%ebp)
8010550e:	e8 ed c9 ff ff       	call   80101f00 <nameiparent>
...
80105524:	e8 57 c1 ff ff       	call   80101680 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105529:	58                   	pop    %eax
8010552a:	5a                   	pop    %edx
8010552b:	68 00 7f 10 80       	push   $0x80107f00
80105530:	53                   	push   %ebx
80105531:	e8 5a c6 ff ff       	call   80101b90 <namecmp>
...
80105544:	68 ff 7e 10 80       	push   $0x80107eff
80105549:	53                   	push   %ebx
8010554a:	e8 41 c6 ff ff       	call   80101b90 <namecmp>
...
80105563:	e8 48 c6 ff ff       	call   80101bb0 <dirlookup>
...
801055ad:	e8 ae c4 ff ff       	call   80101a60 <writei>
...
801055da:	e8 f1 bf ff ff       	call   801015d0 <iupdate>
  iunlockput(ip);
801055df:	89 1c 24             	mov    %ebx,(%esp)
801055e2:	e8 29 c3 ff ff       	call   80101910 <iunlockput>
  end_op();
801055e7:	e8 24 d6 ff ff       	call   80102c10 <end_op>
  return 0;
...
80105624:	e8 37 c3 ff ff       	call   80101960 <readi>
...
8010563c:	e8 cf c2 ff ff       	call   80101910 <iunlockput>
    goto bad;
80105641:	83 c4 10             	add    $0x10,%esp
  iunlockput(dp);
80105644:	83 ec 0c             	sub    $0xc,%esp
80105647:	56                   	push   %esi
80105648:	e8 c3 c2 ff ff       	call   80101910 <iunlockput>
  end_op();
8010564d:	e8 be d5 ff ff       	call   80102c10 <end_op>
  return -1;
...
80105669:	e8 62 bf ff ff       	call   801015d0 <iupdate>
...
8010570d:	e8 ce c7 ff ff       	call   80101ee0 <namei>
...
80105723:	e8 58 bf ff ff       	call   80101680 <ilock>
...
8010576c:	e8 ef bf ff ff       	call   80101760 <iunlock>
  end_op();
...
801057cb:	0f 85 65 ff ff ff    	jne    80105736 <sys_open+0x76>
      end_op();
801057d1:	e8 3a d4 ff ff       	call   80102c10 <end_op>
      return -1;
...
801057ef:	e8 1c c1 ff ff       	call   80101910 <iunlockput>
    end_op();
801057f4:	e8 17 d4 ff ff       	call   80102c10 <end_op>
    return -1;
...
8010580c:	e8 2f b6 ff ff       	call   80100e40 <fileclose>
...
8010586f:	c3                   	ret    
    end_op();
80105870:	e8 9b d3 ff ff       	call   80102c10 <end_op>
    return -1;
...
80105883:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
80105886:	e8 15 d3 ff ff       	call   80102ba0 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
801058ee:	e8 1d c0 ff ff       	call   80101910 <iunlockput>
  end_op();
801058f3:	e8 18 d3 ff ff       	call   80102c10 <end_op>
  return 0;
...
80105915:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105918:	e8 93 df ff ff       	call   801038b0 <myproc>
8010591d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010591f:	e8 7c d2 ff ff       	call   80102ba0 <begin_op>
...
8010593f:	e8 9c c5 ff ff       	call   80101ee0 <namei>
...
80105951:	e8 2a bd ff ff       	call   80101680 <ilock>
  if(ip->type != T_DIR){
...
80105964:	e8 f7 bd ff ff       	call   80101760 <iunlock>
  iput(curproc->cwd);
80105969:	58                   	pop    %eax
8010596a:	ff 76 68             	pushl  0x68(%esi)
8010596d:	e8 3e be ff ff       	call   801017b0 <iput>
  end_op();
80105972:	e8 99 d2 ff ff       	call   80102c10 <end_op>
  curproc->cwd = ip;
...
80105994:	e8 77 bf ff ff       	call   80101910 <iunlockput>
    end_op();
80105999:	e8 72 d2 ff ff       	call   80102c10 <end_op>
    return -1;
...
80105adc:	e8 9f d7 ff ff       	call   80103280 <pipealloc>
...
80105aef:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105af1:	e8 ba dd ff ff       	call   801038b0 <myproc>
...
80105b17:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
80105b1a:	e8 91 dd ff ff       	call   801038b0 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105b51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105b58:	e8 53 dd ff ff       	call   801038b0 <myproc>
...
80105b6e:	e8 cd b2 ff ff       	call   80100e40 <fileclose>
    fileclose(wf);
80105b73:	58                   	pop    %eax
80105b74:	ff 75 e4             	pushl  -0x1c(%ebp)
80105b77:	e8 c4 b2 ff ff       	call   80100e40 <fileclose>
    return -1;
...
80105b93:	5d                   	pop    %ebp
  return fork();
80105b94:	e9 b7 de ff ff       	jmp    80103a50 <fork>
...
80105ba3:	83 ec 08             	sub    $0x8,%esp
  exit();
80105ba6:	e8 75 e1 ff ff       	call   80103d20 <exit>
...
80105bb3:	5d                   	pop    %ebp
  return wait();
80105bb4:	e9 c7 e3 ff ff       	jmp    80103f80 <wait>
...
80105bde:	e8 1d e6 ff ff       	call   80104200 <kill>
...
80105c03:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105c06:	e8 a5 dc ff ff       	call   801038b0 <myproc>
...
80105c36:	e8 95 dd ff ff       	call   801039d0 <growproc>
...
80105c6d:	e8 ee f1 ff ff       	call   80104e60 <argint>
...
80105c80:	68 a0 71 11 80       	push   $0x801171a0
80105c85:	e8 c6 ed ff ff       	call   80104a50 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105c8a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105c8d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
80105c90:	8b 1d e0 79 11 80    	mov    0x801179e0,%ebx
  while(ticks - ticks0 < n){
...
80105ca3:	68 a0 71 11 80       	push   $0x801171a0
80105ca8:	68 e0 79 11 80       	push   $0x801179e0
80105cad:	e8 0e e2 ff ff       	call   80103ec0 <sleep>
  while(ticks - ticks0 < n){
80105cb2:	a1 e0 79 11 80       	mov    0x801179e0,%eax
...
80105cbf:	73 2f                	jae    80105cf0 <sys_sleep+0x90>
    if(myproc()->killed){
80105cc1:	e8 ea db ff ff       	call   801038b0 <myproc>
...
80105cd0:	68 a0 71 11 80       	push   $0x801171a0
80105cd5:	e8 36 ee ff ff       	call   80104b10 <release>
      return -1;
...
80105cf3:	68 a0 71 11 80       	push   $0x801171a0
80105cf8:	e8 13 ee ff ff       	call   80104b10 <release>
  return 0;
...
80105d14:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105d17:	68 a0 71 11 80       	push   $0x801171a0
80105d1c:	e8 2f ed ff ff       	call   80104a50 <acquire>
  xticks = ticks;
80105d21:	8b 1d e0 79 11 80    	mov    0x801179e0,%ebx
  release(&tickslock);
80105d27:	c7 04 24 a0 71 11 80 	movl   $0x801171a0,(%esp)
80105d2e:	e8 dd ed ff ff       	call   80104b10 <release>
  return xticks;
}
...
80105d4e:	e8 5d f1 ff ff       	call   80104eb0 <argptr>
...
80105d65:	e8 46 f1 ff ff       	call   80104eb0 <argptr>
...
80105d7a:	e8 01 e3 ff ff       	call   80104080 <waitx>
...
80105da6:	78 28                	js     80105dd0 <sys_set_priority+0x40>
    return -1;
...
80105db1:	e8 aa f0 ff ff       	call   80104e60 <argint>
80105db6:	83 c4 10             	add    $0x10,%esp
80105db9:	85 c0                	test   %eax,%eax
80105dbb:	78 13                	js     80105dd0 <sys_set_priority+0x40>
    return -1;
...
80105dc6:	e8 e5 e5 ff ff       	call   801043b0 <set_priority>
...
80105de9:	6a 24                	push   $0x24
80105deb:	50                   	push   %eax
80105dec:	6a 00                	push   $0x0
80105dee:	e8 bd f0 ff ff       	call   80104eb0 <argptr>
80105df3:	83 c4 10             	add    $0x10,%esp
80105df6:	85 c0                	test   %eax,%eax
80105df8:	78 2e                	js     80105e28 <sys_getpinfo+0x48>
        return -1;
...
80105e03:	e8 58 f0 ff ff       	call   80104e60 <argint>
80105e08:	83 c4 10             	add    $0x10,%esp
80105e0b:	85 c0                	test   %eax,%eax
80105e0d:	78 19                	js     80105e28 <sys_getpinfo+0x48>
        return -1;
...
80105e18:	e8 43 e8 ff ff       	call   80104660 <getpinfo>
...
80105e3e:	54                   	push   %esp
  call trap
80105e3f:	e8 cc 00 00 00       	call   80105f10 <trap>
  addl $4, %esp
...
80105e77:	c7 04 c5 e2 71 11 80 	movl   $0x8e000008,-0x7fee8e1e(,%eax,8)
80105e7e:	08 00 00 8e 
80105e82:	66 89 14 c5 e0 71 11 	mov    %dx,-0x7fee8e20(,%eax,8)
80105e89:	80 
80105e8a:	c1 ea 10             	shr    $0x10,%edx
80105e8d:	66 89 14 c5 e6 71 11 	mov    %dx,-0x7fee8e1a(,%eax,8)
80105e94:	80 
  for(i = 0; i < 256; i++)
...
80105ea4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ea7:	c7 05 e2 73 11 80 08 	movl   $0xef000008,0x801173e2
80105eae:	00 00 ef 
  initlock(&tickslock, "time");
80105eb1:	68 45 7f 10 80       	push   $0x80107f45
80105eb6:	68 a0 71 11 80       	push   $0x801171a0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105ebb:	66 a3 e0 73 11 80    	mov    %ax,0x801173e0
80105ec1:	c1 e8 10             	shr    $0x10,%eax
80105ec4:	66 a3 e6 73 11 80    	mov    %ax,0x801173e6
  initlock(&tickslock, "time");
80105eca:	e8 41 ea ff ff       	call   80104910 <initlock>
}
80105ecf:	83 c4 10             	add    $0x10,%esp
80105ed2:	c9                   	leave  
80105ed3:	c3                   	ret    
80105ed4:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80105eda:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi
...
80105ee0:	55                   	push   %ebp
  pd[0] = size-1;
80105ee1:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105ee6:	89 e5                	mov    %esp,%ebp
80105ee8:	83 ec 10             	sub    $0x10,%esp
80105eeb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105eef:	b8 e0 71 11 80       	mov    $0x801171e0,%eax
80105ef4:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105ef8:	c1 e8 10             	shr    $0x10,%eax
80105efb:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105eff:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105f02:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105f05:	c9                   	leave  
80105f06:	c3                   	ret    
...
80105f16:	83 ec 1c             	sub    $0x1c,%esp
80105f19:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(tf->trapno == T_SYSCALL){
80105f1c:	8b 47 30             	mov    0x30(%edi),%eax
80105f1f:	83 f8 40             	cmp    $0x40,%eax
80105f22:	0f 84 f0 00 00 00    	je     80106018 <trap+0x108>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105f28:	83 e8 20             	sub    $0x20,%eax
80105f2b:	83 f8 1f             	cmp    $0x1f,%eax
80105f2e:	77 10                	ja     80105f40 <trap+0x30>
80105f30:	ff 24 85 ec 7f 10 80 	jmp    *-0x7fef8014(,%eax,4)
...
80105f40:	e8 6b d9 ff ff       	call   801038b0 <myproc>
80105f45:	85 c0                	test   %eax,%eax
80105f47:	8b 5f 38             	mov    0x38(%edi),%ebx
80105f4a:	0f 84 59 02 00 00    	je     801061a9 <trap+0x299>
80105f50:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105f54:	0f 84 4f 02 00 00    	je     801061a9 <trap+0x299>
...
80105f60:	e8 2b d9 ff ff       	call   80103890 <cpuid>
80105f65:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105f68:	8b 47 34             	mov    0x34(%edi),%eax
80105f6b:	8b 77 30             	mov    0x30(%edi),%esi
80105f6e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105f71:	e8 3a d9 ff ff       	call   801038b0 <myproc>
80105f76:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105f79:	e8 32 d9 ff ff       	call   801038b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105f86:	52                   	push   %edx
            myproc()->pid, myproc()->name, tf->trapno,
80105f87:	8b 55 e0             	mov    -0x20(%ebp),%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105f8a:	ff 75 e4             	pushl  -0x1c(%ebp)
80105f8d:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105f8e:	83 c2 6c             	add    $0x6c,%edx
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105f91:	52                   	push   %edx
80105f92:	ff 70 10             	pushl  0x10(%eax)
80105f95:	68 a8 7f 10 80       	push   $0x80107fa8
80105f9a:	e8 c1 a6 ff ff       	call   80100660 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105f9f:	83 c4 20             	add    $0x20,%esp
80105fa2:	e8 09 d9 ff ff       	call   801038b0 <myproc>
...
80105fae:	e8 fd d8 ff ff       	call   801038b0 <myproc>
80105fb3:	85 c0                	test   %eax,%eax
80105fb5:	74 1d                	je     80105fd4 <trap+0xc4>
80105fb7:	e8 f4 d8 ff ff       	call   801038b0 <myproc>
80105fbc:	8b 50 24             	mov    0x24(%eax),%edx
80105fbf:	85 d2                	test   %edx,%edx
80105fc1:	74 11                	je     80105fd4 <trap+0xc4>
80105fc3:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80105fc7:	83 e0 03             	and    $0x3,%eax
80105fca:	66 83 f8 03          	cmp    $0x3,%ax
80105fce:	0f 84 74 01 00 00    	je     80106148 <trap+0x238>
...
80105fd4:	e8 d7 d8 ff ff       	call   801038b0 <myproc>
80105fd9:	85 c0                	test   %eax,%eax
80105fdb:	74 0b                	je     80105fe8 <trap+0xd8>
80105fdd:	e8 ce d8 ff ff       	call   801038b0 <myproc>
80105fe2:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105fe6:	74 68                	je     80106050 <trap+0x140>
        }
      }
    #endif
    #endif
    ...
    if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105fe8:	e8 c3 d8 ff ff       	call   801038b0 <myproc>
80105fed:	85 c0                	test   %eax,%eax
80105fef:	74 19                	je     8010600a <trap+0xfa>
80105ff1:	e8 ba d8 ff ff       	call   801038b0 <myproc>
80105ff6:	8b 40 24             	mov    0x24(%eax),%eax
80105ff9:	85 c0                	test   %eax,%eax
80105ffb:	74 0d                	je     8010600a <trap+0xfa>
80105ffd:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
80106001:	83 e0 03             	and    $0x3,%eax
80106004:	66 83 f8 03          	cmp    $0x3,%ax
80106008:	74 37                	je     80106041 <trap+0x131>
      exit();
  #endif
}
...
8010601d:	8b 58 24             	mov    0x24(%eax),%ebx
80106020:	85 db                	test   %ebx,%ebx
80106022:	0f 85 10 01 00 00    	jne    80106138 <trap+0x228>
    myproc()->tf = tf;
80106028:	e8 83 d8 ff ff       	call   801038b0 <myproc>
8010602d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80106030:	e8 1b ef ff ff       	call   80104f50 <syscall>
    if(myproc()->killed)
80106035:	e8 76 d8 ff ff       	call   801038b0 <myproc>
8010603a:	8b 48 24             	mov    0x24(%eax),%ecx
8010603d:	85 c9                	test   %ecx,%ecx
8010603f:	74 c9                	je     8010600a <trap+0xfa>
}
...
80106047:	5d                   	pop    %ebp
      exit();
80106048:	e9 d3 dc ff ff       	jmp    80103d20 <exit>
8010604d:	8d 76 00             	lea    0x0(%esi),%esi
        if(tf->trapno == T_IRQ0+IRQ_TIMER)
80106050:	83 7f 30 20          	cmpl   $0x20,0x30(%edi)
80106054:	0f 84 fe 00 00 00    	je     80106158 <trap+0x248>
          if(higherPriority(myproc()->priority, 0))
8010605a:	e8 51 d8 ff ff       	call   801038b0 <myproc>
8010605f:	83 ec 08             	sub    $0x8,%esp
80106062:	6a 00                	push   $0x0
          if(higherPriority(myproc()->priority, 1))
80106064:	ff b0 8c 00 00 00    	pushl  0x8c(%eax)
8010606a:	e8 b1 e6 ff ff       	call   80104720 <higherPriority>
8010606f:	83 c4 10             	add    $0x10,%esp
80106072:	85 c0                	test   %eax,%eax
80106074:	0f 84 6e ff ff ff    	je     80105fe8 <trap+0xd8>
            yield();
8010607a:	e8 e1 dd ff ff       	call   80103e60 <yield>
8010607f:	e9 64 ff ff ff       	jmp    80105fe8 <trap+0xd8>
80106084:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80106088:	e8 03 d8 ff ff       	call   80103890 <cpuid>
8010608d:	85 c0                	test   %eax,%eax
8010608f:	0f 84 db 00 00 00    	je     80106170 <trap+0x260>
    lapiceoi();
80106095:	e8 b6 c6 ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
8010609a:	e8 11 d8 ff ff       	call   801038b0 <myproc>
8010609f:	85 c0                	test   %eax,%eax
801060a1:	0f 85 10 ff ff ff    	jne    80105fb7 <trap+0xa7>
801060a7:	e9 28 ff ff ff       	jmp    80105fd4 <trap+0xc4>
801060ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
801060b0:	e8 5b c5 ff ff       	call   80102610 <kbdintr>
    lapiceoi();
801060b5:	e8 96 c6 ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060ba:	e8 f1 d7 ff ff       	call   801038b0 <myproc>
801060bf:	85 c0                	test   %eax,%eax
801060c1:	0f 85 f0 fe ff ff    	jne    80105fb7 <trap+0xa7>
801060c7:	e9 08 ff ff ff       	jmp    80105fd4 <trap+0xc4>
801060cc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
801060d0:	e8 7b 02 00 00       	call   80106350 <uartintr>
    lapiceoi();
801060d5:	e8 76 c6 ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801060da:	e8 d1 d7 ff ff       	call   801038b0 <myproc>
801060df:	85 c0                	test   %eax,%eax
801060e1:	0f 85 d0 fe ff ff    	jne    80105fb7 <trap+0xa7>
801060e7:	e9 e8 fe ff ff       	jmp    80105fd4 <trap+0xc4>
...
801060f7:	e8 94 d7 ff ff       	call   80103890 <cpuid>
801060fc:	56                   	push   %esi
801060fd:	53                   	push   %ebx
801060fe:	50                   	push   %eax
801060ff:	68 50 7f 10 80       	push   $0x80107f50
80106104:	e8 57 a5 ff ff       	call   80100660 <cprintf>
    lapiceoi();
80106109:	e8 42 c6 ff ff       	call   80102750 <lapiceoi>
    break;
8010610e:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80106111:	e8 9a d7 ff ff       	call   801038b0 <myproc>
80106116:	85 c0                	test   %eax,%eax
80106118:	0f 85 99 fe ff ff    	jne    80105fb7 <trap+0xa7>
8010611e:	e9 b1 fe ff ff       	jmp    80105fd4 <trap+0xc4>
80106123:	90                   	nop
80106124:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80106128:	e8 53 bf ff ff       	call   80102080 <ideintr>
8010612d:	e9 63 ff ff ff       	jmp    80106095 <trap+0x185>
80106132:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80106138:	e8 e3 db ff ff       	call   80103d20 <exit>
8010613d:	e9 e6 fe ff ff       	jmp    80106028 <trap+0x118>
80106142:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80106148:	e8 d3 db ff ff       	call   80103d20 <exit>
8010614d:	e9 82 fe ff ff       	jmp    80105fd4 <trap+0xc4>
80106152:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
          if(higherPriority(myproc()->priority, 1))
80106158:	e8 53 d7 ff ff       	call   801038b0 <myproc>
8010615d:	83 ec 08             	sub    $0x8,%esp
80106160:	6a 01                	push   $0x1
80106162:	e9 fd fe ff ff       	jmp    80106064 <trap+0x154>
80106167:	89 f6                	mov    %esi,%esi
80106169:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
      acquire(&tickslock);
80106170:	83 ec 0c             	sub    $0xc,%esp
80106173:	68 a0 71 11 80       	push   $0x801171a0
80106178:	e8 d3 e8 ff ff       	call   80104a50 <acquire>
      ticks++;
8010617d:	83 05 e0 79 11 80 01 	addl   $0x1,0x801179e0
      update_proc_time();
80106184:	e8 c7 e1 ff ff       	call   80104350 <update_proc_time>
      wakeup(&ticks);
80106189:	c7 04 24 e0 79 11 80 	movl   $0x801179e0,(%esp)
80106190:	e8 0b e0 ff ff       	call   801041a0 <wakeup>
      release(&tickslock);
80106195:	c7 04 24 a0 71 11 80 	movl   $0x801171a0,(%esp)
8010619c:	e8 6f e9 ff ff       	call   80104b10 <release>
801061a1:	83 c4 10             	add    $0x10,%esp
801061a4:	e9 ec fe ff ff       	jmp    80106095 <trap+0x185>
801061a9:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801061ac:	e8 df d6 ff ff       	call   80103890 <cpuid>
801061b1:	83 ec 0c             	sub    $0xc,%esp
801061b4:	56                   	push   %esi
801061b5:	53                   	push   %ebx
801061b6:	50                   	push   %eax
801061b7:	ff 77 30             	pushl  0x30(%edi)
801061ba:	68 74 7f 10 80       	push   $0x80107f74
801061bf:	e8 9c a4 ff ff       	call   80100660 <cprintf>
      panic("trap");
801061c4:	83 c4 14             	add    $0x14,%esp
801061c7:	68 4a 7f 10 80       	push   $0x80107f4a
801061cc:	e8 bf a1 ff ff       	call   80100390 <panic>
801061d1:	66 90                	xchg   %ax,%ax
801061d3:	66 90                	xchg   %ax,%ax
801061d5:	66 90                	xchg   %ax,%ax
...
{
  if(!uart)
801061e0:	a1 bc b5 10 80       	mov    0x8010b5bc,%eax
{
801061e5:	55                   	push   %ebp
801061e6:	89 e5                	mov    %esp,%ebp
  if(!uart)
801061e8:	85 c0                	test   %eax,%eax
801061ea:	74 1c                	je     80106208 <uartgetc+0x28>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801061ec:	ba fd 03 00 00       	mov    $0x3fd,%edx
801061f1:	ec                   	in     (%dx),%al
    return -1;
  if(!(inb(COM1+5) & 0x01))
801061f2:	a8 01                	test   $0x1,%al
801061f4:	74 12                	je     80106208 <uartgetc+0x28>
801061f6:	ba f8 03 00 00       	mov    $0x3f8,%edx
801061fb:	ec                   	in     (%dx),%al
    return -1;
  return inb(COM1+0);
801061fc:	0f b6 c0             	movzbl %al,%eax
}
801061ff:	5d                   	pop    %ebp
80106200:	c3                   	ret    
...
80106216:	89 c7                	mov    %eax,%edi
80106218:	bb 80 00 00 00       	mov    $0x80,%ebx
8010621d:	be fd 03 00 00       	mov    $0x3fd,%esi
80106222:	83 ec 0c             	sub    $0xc,%esp
80106225:	eb 1b                	jmp    80106242 <uartputc.part.0+0x32>
...
80106235:	e8 36 c5 ff ff       	call   80102770 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
8010623a:	83 c4 10             	add    $0x10,%esp
8010623d:	83 eb 01             	sub    $0x1,%ebx
80106240:	74 07                	je     80106249 <uartputc.part.0+0x39>
80106242:	89 f2                	mov    %esi,%edx
80106244:	ec                   	in     (%dx),%al
80106245:	a8 20                	test   $0x20,%al
80106247:	74 e7                	je     80106230 <uartputc.part.0+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106249:	ba f8 03 00 00       	mov    $0x3f8,%edx
8010624e:	89 f8                	mov    %edi,%eax
...
801062b7:	74 5a                	je     80106313 <uartinit+0xb3>
  uart = 1;
801062b9:	c7 05 bc b5 10 80 01 	movl   $0x1,0x8010b5bc
801062c0:	00 00 00 
...
801062cc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
801062cf:	bb 6c 80 10 80       	mov    $0x8010806c,%ebx
  ioapicenable(IRQ_COM1, 0);
801062d4:	6a 00                	push   $0x0
801062d6:	6a 04                	push   $0x4
801062d8:	e8 f3 bf ff ff       	call   801022d0 <ioapicenable>
801062dd:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
801062e0:	b8 78 00 00 00       	mov    $0x78,%eax
801062e5:	eb 13                	jmp    801062fa <uartinit+0x9a>
801062e7:	89 f6                	mov    %esi,%esi
801062e9:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
801062f0:	83 c3 01             	add    $0x1,%ebx
801062f3:	0f be 03             	movsbl (%ebx),%eax
801062f6:	84 c0                	test   %al,%al
801062f8:	74 19                	je     80106313 <uartinit+0xb3>
  if(!uart)
801062fa:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
80106300:	85 d2                	test   %edx,%edx
80106302:	74 ec                	je     801062f0 <uartinit+0x90>
  for(p="xv6...\n"; *p; p++)
80106304:	83 c3 01             	add    $0x1,%ebx
80106307:	e8 04 ff ff ff       	call   80106210 <uartputc.part.0>
8010630c:	0f be 03             	movsbl (%ebx),%eax
8010630f:	84 c0                	test   %al,%al
80106311:	75 e7                	jne    801062fa <uartinit+0x9a>
}
80106313:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106316:	5b                   	pop    %ebx
80106317:	5e                   	pop    %esi
80106318:	5f                   	pop    %edi
80106319:	5d                   	pop    %ebp
...
80106320 <uartputc>:
  if(!uart)
80106320:	8b 15 bc b5 10 80    	mov    0x8010b5bc,%edx
{
...
8010632b:	8b 45 08             	mov    0x8(%ebp),%eax
  if(!uart)
8010632e:	74 10                	je     80106340 <uartputc+0x20>
}
80106330:	5d                   	pop    %ebp
80106331:	e9 da fe ff ff       	jmp    80106210 <uartputc.part.0>
...
80106353:	83 ec 14             	sub    $0x14,%esp
  consoleintr(uartgetc);
80106356:	68 e0 61 10 80       	push   $0x801061e0
8010635b:	e8 b0 a4 ff ff       	call   80100810 <consoleintr>
}
...
80106367:	6a 00                	push   $0x0
  jmp alltraps
80106369:	e9 c1 fa ff ff       	jmp    80105e2f <alltraps>
...
80106370:	6a 01                	push   $0x1
  jmp alltraps
80106372:	e9 b8 fa ff ff       	jmp    80105e2f <alltraps>
...
80106377:	6a 00                	push   $0x0
  pushl $2
80106379:	6a 02                	push   $0x2
  jmp alltraps
8010637b:	e9 af fa ff ff       	jmp    80105e2f <alltraps>
...
80106382:	6a 03                	push   $0x3
  jmp alltraps
80106384:	e9 a6 fa ff ff       	jmp    80105e2f <alltraps>
...
8010638b:	6a 04                	push   $0x4
  jmp alltraps
8010638d:	e9 9d fa ff ff       	jmp    80105e2f <alltraps>
...
80106392:	6a 00                	push   $0x0
  pushl $5
80106394:	6a 05                	push   $0x5
  jmp alltraps
80106396:	e9 94 fa ff ff       	jmp    80105e2f <alltraps>
...
8010639b:	6a 00                	push   $0x0
  pushl $6
8010639d:	6a 06                	push   $0x6
  jmp alltraps
8010639f:	e9 8b fa ff ff       	jmp    80105e2f <alltraps>
...
801063a4:	6a 00                	push   $0x0
  pushl $7
801063a6:	6a 07                	push   $0x7
  jmp alltraps
801063a8:	e9 82 fa ff ff       	jmp    80105e2f <alltraps>

801063ad <vector8>:
.globl vector8
vector8:
  pushl $8
801063ad:	6a 08                	push   $0x8
  jmp alltraps
801063af:	e9 7b fa ff ff       	jmp    80105e2f <alltraps>
...
801063b4:	6a 00                	push   $0x0
  pushl $9
801063b6:	6a 09                	push   $0x9
  jmp alltraps
801063b8:	e9 72 fa ff ff       	jmp    80105e2f <alltraps>

801063bd <vector10>:
.globl vector10
vector10:
  pushl $10
801063bd:	6a 0a                	push   $0xa
  jmp alltraps
801063bf:	e9 6b fa ff ff       	jmp    80105e2f <alltraps>

801063c4 <vector11>:
.globl vector11
vector11:
  pushl $11
801063c4:	6a 0b                	push   $0xb
  jmp alltraps
801063c6:	e9 64 fa ff ff       	jmp    80105e2f <alltraps>

801063cb <vector12>:
.globl vector12
vector12:
  pushl $12
801063cb:	6a 0c                	push   $0xc
  jmp alltraps
801063cd:	e9 5d fa ff ff       	jmp    80105e2f <alltraps>

801063d2 <vector13>:
.globl vector13
vector13:
  pushl $13
801063d2:	6a 0d                	push   $0xd
  jmp alltraps
801063d4:	e9 56 fa ff ff       	jmp    80105e2f <alltraps>

801063d9 <vector14>:
.globl vector14
vector14:
  pushl $14
801063d9:	6a 0e                	push   $0xe
  jmp alltraps
801063db:	e9 4f fa ff ff       	jmp    80105e2f <alltraps>
...
801063e0:	6a 00                	push   $0x0
  pushl $15
801063e2:	6a 0f                	push   $0xf
  jmp alltraps
801063e4:	e9 46 fa ff ff       	jmp    80105e2f <alltraps>
...
801063e9:	6a 00                	push   $0x0
  pushl $16
801063eb:	6a 10                	push   $0x10
  jmp alltraps
801063ed:	e9 3d fa ff ff       	jmp    80105e2f <alltraps>

801063f2 <vector17>:
.globl vector17
vector17:
  pushl $17
801063f2:	6a 11                	push   $0x11
  jmp alltraps
801063f4:	e9 36 fa ff ff       	jmp    80105e2f <alltraps>
...
801063f9:	6a 00                	push   $0x0
  pushl $18
801063fb:	6a 12                	push   $0x12
  jmp alltraps
801063fd:	e9 2d fa ff ff       	jmp    80105e2f <alltraps>
...
80106402:	6a 00                	push   $0x0
  pushl $19
80106404:	6a 13                	push   $0x13
  jmp alltraps
80106406:	e9 24 fa ff ff       	jmp    80105e2f <alltraps>
...
8010640b:	6a 00                	push   $0x0
  pushl $20
8010640d:	6a 14                	push   $0x14
  jmp alltraps
8010640f:	e9 1b fa ff ff       	jmp    80105e2f <alltraps>
...
80106414:	6a 00                	push   $0x0
  pushl $21
80106416:	6a 15                	push   $0x15
  jmp alltraps
80106418:	e9 12 fa ff ff       	jmp    80105e2f <alltraps>
...
8010641d:	6a 00                	push   $0x0
  pushl $22
8010641f:	6a 16                	push   $0x16
  jmp alltraps
80106421:	e9 09 fa ff ff       	jmp    80105e2f <alltraps>
...
80106426:	6a 00                	push   $0x0
  pushl $23
80106428:	6a 17                	push   $0x17
  jmp alltraps
8010642a:	e9 00 fa ff ff       	jmp    80105e2f <alltraps>
...
8010642f:	6a 00                	push   $0x0
  pushl $24
80106431:	6a 18                	push   $0x18
  jmp alltraps
80106433:	e9 f7 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106438:	6a 00                	push   $0x0
  pushl $25
8010643a:	6a 19                	push   $0x19
  jmp alltraps
8010643c:	e9 ee f9 ff ff       	jmp    80105e2f <alltraps>
...
80106441:	6a 00                	push   $0x0
  pushl $26
80106443:	6a 1a                	push   $0x1a
  jmp alltraps
80106445:	e9 e5 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010644a:	6a 00                	push   $0x0
  pushl $27
8010644c:	6a 1b                	push   $0x1b
  jmp alltraps
8010644e:	e9 dc f9 ff ff       	jmp    80105e2f <alltraps>
...
80106453:	6a 00                	push   $0x0
  pushl $28
80106455:	6a 1c                	push   $0x1c
  jmp alltraps
80106457:	e9 d3 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010645c:	6a 00                	push   $0x0
  pushl $29
8010645e:	6a 1d                	push   $0x1d
  jmp alltraps
80106460:	e9 ca f9 ff ff       	jmp    80105e2f <alltraps>
...
80106465:	6a 00                	push   $0x0
  pushl $30
80106467:	6a 1e                	push   $0x1e
  jmp alltraps
80106469:	e9 c1 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010646e:	6a 00                	push   $0x0
  pushl $31
80106470:	6a 1f                	push   $0x1f
  jmp alltraps
80106472:	e9 b8 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106477:	6a 00                	push   $0x0
  pushl $32
80106479:	6a 20                	push   $0x20
  jmp alltraps
8010647b:	e9 af f9 ff ff       	jmp    80105e2f <alltraps>
...
80106480:	6a 00                	push   $0x0
  pushl $33
80106482:	6a 21                	push   $0x21
  jmp alltraps
80106484:	e9 a6 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106489:	6a 00                	push   $0x0
  pushl $34
8010648b:	6a 22                	push   $0x22
  jmp alltraps
8010648d:	e9 9d f9 ff ff       	jmp    80105e2f <alltraps>
...
80106492:	6a 00                	push   $0x0
  pushl $35
80106494:	6a 23                	push   $0x23
  jmp alltraps
80106496:	e9 94 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064ad:	6a 00                	push   $0x0
  pushl $38
801064af:	6a 26                	push   $0x26
  jmp alltraps
801064b1:	e9 79 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064b6:	6a 00                	push   $0x0
  pushl $39
801064b8:	6a 27                	push   $0x27
  jmp alltraps
801064ba:	e9 70 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064bf:	6a 00                	push   $0x0
  pushl $40
801064c1:	6a 28                	push   $0x28
  jmp alltraps
801064c3:	e9 67 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064c8:	6a 00                	push   $0x0
  pushl $41
801064ca:	6a 29                	push   $0x29
  jmp alltraps
801064cc:	e9 5e f9 ff ff       	jmp    80105e2f <alltraps>
...
801064d1:	6a 00                	push   $0x0
  pushl $42
801064d3:	6a 2a                	push   $0x2a
  jmp alltraps
801064d5:	e9 55 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064da:	6a 00                	push   $0x0
  pushl $43
801064dc:	6a 2b                	push   $0x2b
  jmp alltraps
801064de:	e9 4c f9 ff ff       	jmp    80105e2f <alltraps>
...
801064e3:	6a 00                	push   $0x0
  pushl $44
801064e5:	6a 2c                	push   $0x2c
  jmp alltraps
801064e7:	e9 43 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064ec:	6a 00                	push   $0x0
  pushl $45
801064ee:	6a 2d                	push   $0x2d
  jmp alltraps
801064f0:	e9 3a f9 ff ff       	jmp    80105e2f <alltraps>
...
801064f5:	6a 00                	push   $0x0
  pushl $46
801064f7:	6a 2e                	push   $0x2e
  jmp alltraps
801064f9:	e9 31 f9 ff ff       	jmp    80105e2f <alltraps>
...
801064fe:	6a 00                	push   $0x0
  pushl $47
80106500:	6a 2f                	push   $0x2f
  jmp alltraps
80106502:	e9 28 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106507:	6a 00                	push   $0x0
  pushl $48
80106509:	6a 30                	push   $0x30
  jmp alltraps
8010650b:	e9 1f f9 ff ff       	jmp    80105e2f <alltraps>
...
80106510:	6a 00                	push   $0x0
  pushl $49
80106512:	6a 31                	push   $0x31
  jmp alltraps
80106514:	e9 16 f9 ff ff       	jmp    80105e2f <alltraps>
...
80106519:	6a 00                	push   $0x0
  pushl $50
8010651b:	6a 32                	push   $0x32
  jmp alltraps
8010651d:	e9 0d f9 ff ff       	jmp    80105e2f <alltraps>
...
80106522:	6a 00                	push   $0x0
  pushl $51
80106524:	6a 33                	push   $0x33
  jmp alltraps
80106526:	e9 04 f9 ff ff       	jmp    80105e2f <alltraps>
...
8010652b:	6a 00                	push   $0x0
  pushl $52
8010652d:	6a 34                	push   $0x34
  jmp alltraps
8010652f:	e9 fb f8 ff ff       	jmp    80105e2f <alltraps>
...
80106534:	6a 00                	push   $0x0
  pushl $53
80106536:	6a 35                	push   $0x35
  jmp alltraps
80106538:	e9 f2 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010653d:	6a 00                	push   $0x0
  pushl $54
8010653f:	6a 36                	push   $0x36
  jmp alltraps
80106541:	e9 e9 f8 ff ff       	jmp    80105e2f <alltraps>
...
80106546:	6a 00                	push   $0x0
  pushl $55
80106548:	6a 37                	push   $0x37
  jmp alltraps
8010654a:	e9 e0 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010654f:	6a 00                	push   $0x0
  pushl $56
80106551:	6a 38                	push   $0x38
  jmp alltraps
80106553:	e9 d7 f8 ff ff       	jmp    80105e2f <alltraps>
...
80106558:	6a 00                	push   $0x0
  pushl $57
8010655a:	6a 39                	push   $0x39
  jmp alltraps
8010655c:	e9 ce f8 ff ff       	jmp    80105e2f <alltraps>
...
80106561:	6a 00                	push   $0x0
  pushl $58
80106563:	6a 3a                	push   $0x3a
  jmp alltraps
80106565:	e9 c5 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010656a:	6a 00                	push   $0x0
  pushl $59
8010656c:	6a 3b                	push   $0x3b
  jmp alltraps
8010656e:	e9 bc f8 ff ff       	jmp    80105e2f <alltraps>
...
80106573:	6a 00                	push   $0x0
  pushl $60
80106575:	6a 3c                	push   $0x3c
  jmp alltraps
80106577:	e9 b3 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010657c:	6a 00                	push   $0x0
  pushl $61
8010657e:	6a 3d                	push   $0x3d
  jmp alltraps
80106580:	e9 aa f8 ff ff       	jmp    80105e2f <alltraps>
...
80106585:	6a 00                	push   $0x0
  pushl $62
80106587:	6a 3e                	push   $0x3e
  jmp alltraps
80106589:	e9 a1 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010658e:	6a 00                	push   $0x0
  pushl $63
80106590:	6a 3f                	push   $0x3f
  jmp alltraps
80106592:	e9 98 f8 ff ff       	jmp    80105e2f <alltraps>
...
80106597:	6a 00                	push   $0x0
  pushl $64
80106599:	6a 40                	push   $0x40
  jmp alltraps
8010659b:	e9 8f f8 ff ff       	jmp    80105e2f <alltraps>
...
801065a0:	6a 00                	push   $0x0
  pushl $65
801065a2:	6a 41                	push   $0x41
  jmp alltraps
801065a4:	e9 86 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065a9:	6a 00                	push   $0x0
  pushl $66
801065ab:	6a 42                	push   $0x42
  jmp alltraps
801065ad:	e9 7d f8 ff ff       	jmp    80105e2f <alltraps>
...
801065b2:	6a 00                	push   $0x0
  pushl $67
801065b4:	6a 43                	push   $0x43
  jmp alltraps
801065b6:	e9 74 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065bb:	6a 00                	push   $0x0
  pushl $68
801065bd:	6a 44                	push   $0x44
  jmp alltraps
801065bf:	e9 6b f8 ff ff       	jmp    80105e2f <alltraps>
...
801065c4:	6a 00                	push   $0x0
  pushl $69
801065c6:	6a 45                	push   $0x45
  jmp alltraps
801065c8:	e9 62 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065cd:	6a 00                	push   $0x0
  pushl $70
801065cf:	6a 46                	push   $0x46
  jmp alltraps
801065d1:	e9 59 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065d6:	6a 00                	push   $0x0
  pushl $71
801065d8:	6a 47                	push   $0x47
  jmp alltraps
801065da:	e9 50 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065df:	6a 00                	push   $0x0
  pushl $72
801065e1:	6a 48                	push   $0x48
  jmp alltraps
801065e3:	e9 47 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065e8:	6a 00                	push   $0x0
  pushl $73
801065ea:	6a 49                	push   $0x49
  jmp alltraps
801065ec:	e9 3e f8 ff ff       	jmp    80105e2f <alltraps>
...
801065f1:	6a 00                	push   $0x0
  pushl $74
801065f3:	6a 4a                	push   $0x4a
  jmp alltraps
801065f5:	e9 35 f8 ff ff       	jmp    80105e2f <alltraps>
...
801065fa:	6a 00                	push   $0x0
  pushl $75
801065fc:	6a 4b                	push   $0x4b
  jmp alltraps
801065fe:	e9 2c f8 ff ff       	jmp    80105e2f <alltraps>
...
80106603:	6a 00                	push   $0x0
  pushl $76
80106605:	6a 4c                	push   $0x4c
  jmp alltraps
80106607:	e9 23 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010660c:	6a 00                	push   $0x0
  pushl $77
8010660e:	6a 4d                	push   $0x4d
  jmp alltraps
80106610:	e9 1a f8 ff ff       	jmp    80105e2f <alltraps>
...
80106615:	6a 00                	push   $0x0
  pushl $78
80106617:	6a 4e                	push   $0x4e
  jmp alltraps
80106619:	e9 11 f8 ff ff       	jmp    80105e2f <alltraps>
...
8010661e:	6a 00                	push   $0x0
  pushl $79
80106620:	6a 4f                	push   $0x4f
  jmp alltraps
80106622:	e9 08 f8 ff ff       	jmp    80105e2f <alltraps>
...
80106627:	6a 00                	push   $0x0
  pushl $80
80106629:	6a 50                	push   $0x50
  jmp alltraps
8010662b:	e9 ff f7 ff ff       	jmp    80105e2f <alltraps>
...
80106630:	6a 00                	push   $0x0
  pushl $81
80106632:	6a 51                	push   $0x51
  jmp alltraps
80106634:	e9 f6 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106639:	6a 00                	push   $0x0
  pushl $82
8010663b:	6a 52                	push   $0x52
  jmp alltraps
8010663d:	e9 ed f7 ff ff       	jmp    80105e2f <alltraps>
...
80106642:	6a 00                	push   $0x0
  pushl $83
80106644:	6a 53                	push   $0x53
  jmp alltraps
80106646:	e9 e4 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010664b:	6a 00                	push   $0x0
  pushl $84
8010664d:	6a 54                	push   $0x54
  jmp alltraps
8010664f:	e9 db f7 ff ff       	jmp    80105e2f <alltraps>
...
80106654:	6a 00                	push   $0x0
  pushl $85
80106656:	6a 55                	push   $0x55
  jmp alltraps
80106658:	e9 d2 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010665d:	6a 00                	push   $0x0
  pushl $86
8010665f:	6a 56                	push   $0x56
  jmp alltraps
80106661:	e9 c9 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106666:	6a 00                	push   $0x0
  pushl $87
80106668:	6a 57                	push   $0x57
  jmp alltraps
8010666a:	e9 c0 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010666f:	6a 00                	push   $0x0
  pushl $88
80106671:	6a 58                	push   $0x58
  jmp alltraps
80106673:	e9 b7 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106678:	6a 00                	push   $0x0
  pushl $89
8010667a:	6a 59                	push   $0x59
  jmp alltraps
8010667c:	e9 ae f7 ff ff       	jmp    80105e2f <alltraps>
...
80106681:	6a 00                	push   $0x0
  pushl $90
80106683:	6a 5a                	push   $0x5a
  jmp alltraps
80106685:	e9 a5 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010668a:	6a 00                	push   $0x0
  pushl $91
8010668c:	6a 5b                	push   $0x5b
  jmp alltraps
8010668e:	e9 9c f7 ff ff       	jmp    80105e2f <alltraps>
...
80106693:	6a 00                	push   $0x0
  pushl $92
80106695:	6a 5c                	push   $0x5c
  jmp alltraps
80106697:	e9 93 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010669c:	6a 00                	push   $0x0
  pushl $93
8010669e:	6a 5d                	push   $0x5d
  jmp alltraps
801066a0:	e9 8a f7 ff ff       	jmp    80105e2f <alltraps>
...
801066a5:	6a 00                	push   $0x0
  pushl $94
801066a7:	6a 5e                	push   $0x5e
  jmp alltraps
801066a9:	e9 81 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066ae:	6a 00                	push   $0x0
  pushl $95
801066b0:	6a 5f                	push   $0x5f
  jmp alltraps
801066b2:	e9 78 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066b7:	6a 00                	push   $0x0
  pushl $96
801066b9:	6a 60                	push   $0x60
  jmp alltraps
801066bb:	e9 6f f7 ff ff       	jmp    80105e2f <alltraps>
...
801066c0:	6a 00                	push   $0x0
  pushl $97
801066c2:	6a 61                	push   $0x61
  jmp alltraps
801066c4:	e9 66 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066c9:	6a 00                	push   $0x0
  pushl $98
801066cb:	6a 62                	push   $0x62
  jmp alltraps
801066cd:	e9 5d f7 ff ff       	jmp    80105e2f <alltraps>
...
801066d2:	6a 00                	push   $0x0
  pushl $99
801066d4:	6a 63                	push   $0x63
  jmp alltraps
801066d6:	e9 54 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066db:	6a 00                	push   $0x0
  pushl $100
801066dd:	6a 64                	push   $0x64
  jmp alltraps
801066df:	e9 4b f7 ff ff       	jmp    80105e2f <alltraps>
...
801066e4:	6a 00                	push   $0x0
  pushl $101
801066e6:	6a 65                	push   $0x65
  jmp alltraps
801066e8:	e9 42 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066ed:	6a 00                	push   $0x0
  pushl $102
801066ef:	6a 66                	push   $0x66
  jmp alltraps
801066f1:	e9 39 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066f6:	6a 00                	push   $0x0
  pushl $103
801066f8:	6a 67                	push   $0x67
  jmp alltraps
801066fa:	e9 30 f7 ff ff       	jmp    80105e2f <alltraps>
...
801066ff:	6a 00                	push   $0x0
  pushl $104
80106701:	6a 68                	push   $0x68
  jmp alltraps
80106703:	e9 27 f7 ff ff       	jmp    80105e2f <alltraps>
...
80106708:	6a 00                	push   $0x0
  pushl $105
8010670a:	6a 69                	push   $0x69
  jmp alltraps
8010670c:	e9 1e f7 ff ff       	jmp    80105e2f <alltraps>
...
80106711:	6a 00                	push   $0x0
  pushl $106
80106713:	6a 6a                	push   $0x6a
  jmp alltraps
80106715:	e9 15 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010671a:	6a 00                	push   $0x0
  pushl $107
8010671c:	6a 6b                	push   $0x6b
  jmp alltraps
8010671e:	e9 0c f7 ff ff       	jmp    80105e2f <alltraps>
...
80106723:	6a 00                	push   $0x0
  pushl $108
80106725:	6a 6c                	push   $0x6c
  jmp alltraps
80106727:	e9 03 f7 ff ff       	jmp    80105e2f <alltraps>
...
8010672c:	6a 00                	push   $0x0
  pushl $109
8010672e:	6a 6d                	push   $0x6d
  jmp alltraps
80106730:	e9 fa f6 ff ff       	jmp    80105e2f <alltraps>
...
80106735:	6a 00                	push   $0x0
  pushl $110
80106737:	6a 6e                	push   $0x6e
  jmp alltraps
80106739:	e9 f1 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010673e:	6a 00                	push   $0x0
  pushl $111
80106740:	6a 6f                	push   $0x6f
  jmp alltraps
80106742:	e9 e8 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106747:	6a 00                	push   $0x0
  pushl $112
80106749:	6a 70                	push   $0x70
  jmp alltraps
8010674b:	e9 df f6 ff ff       	jmp    80105e2f <alltraps>
...
80106750:	6a 00                	push   $0x0
  pushl $113
80106752:	6a 71                	push   $0x71
  jmp alltraps
80106754:	e9 d6 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106759:	6a 00                	push   $0x0
  pushl $114
8010675b:	6a 72                	push   $0x72
  jmp alltraps
8010675d:	e9 cd f6 ff ff       	jmp    80105e2f <alltraps>
...
80106762:	6a 00                	push   $0x0
  pushl $115
80106764:	6a 73                	push   $0x73
  jmp alltraps
80106766:	e9 c4 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010676b:	6a 00                	push   $0x0
  pushl $116
8010676d:	6a 74                	push   $0x74
  jmp alltraps
8010676f:	e9 bb f6 ff ff       	jmp    80105e2f <alltraps>
...
80106774:	6a 00                	push   $0x0
  pushl $117
80106776:	6a 75                	push   $0x75
  jmp alltraps
80106778:	e9 b2 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010677d:	6a 00                	push   $0x0
  pushl $118
8010677f:	6a 76                	push   $0x76
  jmp alltraps
80106781:	e9 a9 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106786:	6a 00                	push   $0x0
  pushl $119
80106788:	6a 77                	push   $0x77
  jmp alltraps
8010678a:	e9 a0 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010678f:	6a 00                	push   $0x0
  pushl $120
80106791:	6a 78                	push   $0x78
  jmp alltraps
80106793:	e9 97 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106798:	6a 00                	push   $0x0
  pushl $121
8010679a:	6a 79                	push   $0x79
  jmp alltraps
8010679c:	e9 8e f6 ff ff       	jmp    80105e2f <alltraps>
...
801067a1:	6a 00                	push   $0x0
  pushl $122
801067a3:	6a 7a                	push   $0x7a
  jmp alltraps
801067a5:	e9 85 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067aa:	6a 00                	push   $0x0
  pushl $123
801067ac:	6a 7b                	push   $0x7b
  jmp alltraps
801067ae:	e9 7c f6 ff ff       	jmp    80105e2f <alltraps>
...
801067b3:	6a 00                	push   $0x0
  pushl $124
801067b5:	6a 7c                	push   $0x7c
  jmp alltraps
801067b7:	e9 73 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067bc:	6a 00                	push   $0x0
  pushl $125
801067be:	6a 7d                	push   $0x7d
  jmp alltraps
801067c0:	e9 6a f6 ff ff       	jmp    80105e2f <alltraps>
...
801067c5:	6a 00                	push   $0x0
  pushl $126
801067c7:	6a 7e                	push   $0x7e
  jmp alltraps
801067c9:	e9 61 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067ce:	6a 00                	push   $0x0
  pushl $127
801067d0:	6a 7f                	push   $0x7f
  jmp alltraps
801067d2:	e9 58 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067d7:	6a 00                	push   $0x0
  pushl $128
801067d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801067de:	e9 4c f6 ff ff       	jmp    80105e2f <alltraps>
...
801067e3:	6a 00                	push   $0x0
  pushl $129
801067e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
...
801067ef:	6a 00                	push   $0x0
  pushl $130
801067f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801067f6:	e9 34 f6 ff ff       	jmp    80105e2f <alltraps>
...
801067fb:	6a 00                	push   $0x0
  pushl $131
801067fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106802:	e9 28 f6 ff ff       	jmp    80105e2f <alltraps>
...
80106807:	6a 00                	push   $0x0
  pushl $132
80106809:	68 84 00 00 00       	push   $0x84
  jmp alltraps
...
80106813:	6a 00                	push   $0x0
  pushl $133
80106815:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010681a:	e9 10 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010681f:	6a 00                	push   $0x0
  pushl $134
80106821:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106826:	e9 04 f6 ff ff       	jmp    80105e2f <alltraps>
...
8010682b:	6a 00                	push   $0x0
  pushl $135
8010682d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
...
80106837:	6a 00                	push   $0x0
  pushl $136
80106839:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010683e:	e9 ec f5 ff ff       	jmp    80105e2f <alltraps>
...
80106843:	6a 00                	push   $0x0
  pushl $137
80106845:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010684a:	e9 e0 f5 ff ff       	jmp    80105e2f <alltraps>
...
8010684f:	6a 00                	push   $0x0
  pushl $138
80106851:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
...
8010685b:	6a 00                	push   $0x0
  pushl $139
8010685d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106862:	e9 c8 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106867:	6a 00                	push   $0x0
  pushl $140
80106869:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010686e:	e9 bc f5 ff ff       	jmp    80105e2f <alltraps>
...
80106873:	6a 00                	push   $0x0
  pushl $141
80106875:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
...
8010687f:	6a 00                	push   $0x0
  pushl $142
80106881:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106886:	e9 a4 f5 ff ff       	jmp    80105e2f <alltraps>
...
8010688b:	6a 00                	push   $0x0
  pushl $143
8010688d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106892:	e9 98 f5 ff ff       	jmp    80105e2f <alltraps>
...
80106897:	6a 00                	push   $0x0
  pushl $144
80106899:	68 90 00 00 00       	push   $0x90
  jmp alltraps
...
801068a3:	6a 00                	push   $0x0
  pushl $145
801068a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801068aa:	e9 80 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068af:	6a 00                	push   $0x0
  pushl $146
801068b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801068b6:	e9 74 f5 ff ff       	jmp    80105e2f <alltraps>
...
801068bb:	6a 00                	push   $0x0
  pushl $147
801068bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
...
801068c7:	6a 00                	push   $0x0
  pushl $148
801068c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
...
801068d3:	6a 00                	push   $0x0
  pushl $149
801068d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
...
801068df:	6a 00                	push   $0x0
  pushl $150
801068e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
...
801068eb:	6a 00                	push   $0x0
  pushl $151
801068ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
...
801068f7:	6a 00                	push   $0x0
  pushl $152
801068f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
...
80106903:	6a 00                	push   $0x0
  pushl $153
80106905:	68 99 00 00 00       	push   $0x99
  jmp alltraps
...
8010690f:	6a 00                	push   $0x0
  pushl $154
80106911:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
...
8010691b:	6a 00                	push   $0x0
  pushl $155
8010691d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
...
80106927:	6a 00                	push   $0x0
  pushl $156
80106929:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
...
80106933:	6a 00                	push   $0x0
  pushl $157
80106935:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
...
8010693f:	6a 00                	push   $0x0
  pushl $158
80106941:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
...
8010694b:	6a 00                	push   $0x0
  pushl $159
8010694d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
...
80106957:	6a 00                	push   $0x0
  pushl $160
80106959:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
...
80106963:	6a 00                	push   $0x0
  pushl $161
80106965:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
...
8010696f:	6a 00                	push   $0x0
  pushl $162
80106971:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
...
8010697b:	6a 00                	push   $0x0
  pushl $163
8010697d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
...
80106987:	6a 00                	push   $0x0
  pushl $164
80106989:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
...
80106993:	6a 00                	push   $0x0
  pushl $165
80106995:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
...
8010699f:	6a 00                	push   $0x0
  pushl $166
801069a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
...
801069ab:	6a 00                	push   $0x0
  pushl $167
801069ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
...
801069b7:	6a 00                	push   $0x0
  pushl $168
801069b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
...
801069c3:	6a 00                	push   $0x0
  pushl $169
801069c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
...
801069cf:	6a 00                	push   $0x0
  pushl $170
801069d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
...
801069db:	6a 00                	push   $0x0
  pushl $171
801069dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
...
801069e7:	6a 00                	push   $0x0
  pushl $172
801069e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
...
801069f3:	6a 00                	push   $0x0
  pushl $173
801069f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
...
801069ff:	6a 00                	push   $0x0
  pushl $174
80106a01:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
...
80106a0b:	6a 00                	push   $0x0
  pushl $175
80106a0d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
...
80106a17:	6a 00                	push   $0x0
  pushl $176
80106a19:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
...
80106a23:	6a 00                	push   $0x0
  pushl $177
80106a25:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
...
80106a2f:	6a 00                	push   $0x0
  pushl $178
80106a31:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
...
80106a3b:	6a 00                	push   $0x0
  pushl $179
80106a3d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
...
80106a47:	6a 00                	push   $0x0
  pushl $180
80106a49:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
...
80106a53:	6a 00                	push   $0x0
  pushl $181
80106a55:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
...
80106a5f:	6a 00                	push   $0x0
  pushl $182
80106a61:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
...
80106a6b:	6a 00                	push   $0x0
  pushl $183
80106a6d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
...
80106a77:	6a 00                	push   $0x0
  pushl $184
80106a79:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
...
80106a83:	6a 00                	push   $0x0
  pushl $185
80106a85:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
...
80106a8f:	6a 00                	push   $0x0
  pushl $186
80106a91:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
...
80106a9b:	6a 00                	push   $0x0
  pushl $187
80106a9d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
...
80106aa7:	6a 00                	push   $0x0
  pushl $188
80106aa9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
...
80106ab3:	6a 00                	push   $0x0
  pushl $189
80106ab5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
...
80106abf:	6a 00                	push   $0x0
  pushl $190
80106ac1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
...
80106acb:	6a 00                	push   $0x0
  pushl $191
80106acd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
...
80106ad7:	6a 00                	push   $0x0
  pushl $192
80106ad9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
...
80106ae3:	6a 00                	push   $0x0
  pushl $193
80106ae5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
...
80106aef:	6a 00                	push   $0x0
  pushl $194
80106af1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
...
80106afb:	6a 00                	push   $0x0
  pushl $195
80106afd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
...
80106b07:	6a 00                	push   $0x0
  pushl $196
80106b09:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
...
80106b13:	6a 00                	push   $0x0
  pushl $197
80106b15:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
...
80106b1f:	6a 00                	push   $0x0
  pushl $198
80106b21:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
...
80106b2b:	6a 00                	push   $0x0
  pushl $199
80106b2d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
...
80106b37:	6a 00                	push   $0x0
  pushl $200
80106b39:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
...
80106b43:	6a 00                	push   $0x0
  pushl $201
80106b45:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
...
80106b4f:	6a 00                	push   $0x0
  pushl $202
80106b51:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
...
80106b5b:	6a 00                	push   $0x0
  pushl $203
80106b5d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
...
80106b67:	6a 00                	push   $0x0
  pushl $204
80106b69:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
...
80106b73:	6a 00                	push   $0x0
  pushl $205
80106b75:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
...
80106b7f:	6a 00                	push   $0x0
  pushl $206
80106b81:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
...
80106b8b:	6a 00                	push   $0x0
  pushl $207
80106b8d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
...
80106b97:	6a 00                	push   $0x0
  pushl $208
80106b99:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
...
80106ba3:	6a 00                	push   $0x0
  pushl $209
80106ba5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
...
80106baf:	6a 00                	push   $0x0
  pushl $210
80106bb1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
...
80106bbb:	6a 00                	push   $0x0
  pushl $211
80106bbd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
...
80106bc7:	6a 00                	push   $0x0
  pushl $212
80106bc9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
...
80106bd3:	6a 00                	push   $0x0
  pushl $213
80106bd5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
...
80106bdf:	6a 00                	push   $0x0
  pushl $214
80106be1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
...
80106beb:	6a 00                	push   $0x0
  pushl $215
80106bed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
...
80106bf7:	6a 00                	push   $0x0
  pushl $216
80106bf9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
...
80106c03:	6a 00                	push   $0x0
  pushl $217
80106c05:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
...
80106c0f:	6a 00                	push   $0x0
  pushl $218
80106c11:	68 da 00 00 00       	push   $0xda
  jmp alltraps
...
80106c1b:	6a 00                	push   $0x0
  pushl $219
80106c1d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
...
80106c27:	6a 00                	push   $0x0
  pushl $220
80106c29:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
...
80106c33:	6a 00                	push   $0x0
  pushl $221
80106c35:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
...
80106c3f:	6a 00                	push   $0x0
  pushl $222
80106c41:	68 de 00 00 00       	push   $0xde
  jmp alltraps
...
80106c4b:	6a 00                	push   $0x0
  pushl $223
80106c4d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
...
80106c57:	6a 00                	push   $0x0
  pushl $224
80106c59:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
...
80106c63:	6a 00                	push   $0x0
  pushl $225
80106c65:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
...
80106c6f:	6a 00                	push   $0x0
  pushl $226
80106c71:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
...
80106c7b:	6a 00                	push   $0x0
  pushl $227
80106c7d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
...
80106c87:	6a 00                	push   $0x0
  pushl $228
80106c89:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
...
80106c93:	6a 00                	push   $0x0
  pushl $229
80106c95:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
...
80106c9f:	6a 00                	push   $0x0
  pushl $230
80106ca1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
...
80106cab:	6a 00                	push   $0x0
  pushl $231
80106cad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
...
80106cb7:	6a 00                	push   $0x0
  pushl $232
80106cb9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
...
80106cc3:	6a 00                	push   $0x0
  pushl $233
80106cc5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
...
80106ccf:	6a 00                	push   $0x0
  pushl $234
80106cd1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
...
80106cdb:	6a 00                	push   $0x0
  pushl $235
80106cdd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
...
80106ce7:	6a 00                	push   $0x0
  pushl $236
80106ce9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
...
80106cf3:	6a 00                	push   $0x0
  pushl $237
80106cf5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
...
80106cff:	6a 00                	push   $0x0
  pushl $238
80106d01:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
...
80106d0b:	6a 00                	push   $0x0
  pushl $239
80106d0d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
...
80106d17:	6a 00                	push   $0x0
  pushl $240
80106d19:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
...
80106d23:	6a 00                	push   $0x0
  pushl $241
80106d25:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
...
80106d2f:	6a 00                	push   $0x0
  pushl $242
80106d31:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
...
80106d3b:	6a 00                	push   $0x0
  pushl $243
80106d3d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
...
80106d47:	6a 00                	push   $0x0
  pushl $244
80106d49:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
...
80106d53:	6a 00                	push   $0x0
  pushl $245
80106d55:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
...
80106d5f:	6a 00                	push   $0x0
  pushl $246
80106d61:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
...
80106d6b:	6a 00                	push   $0x0
  pushl $247
80106d6d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
...
80106d77:	6a 00                	push   $0x0
  pushl $248
80106d79:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
...
80106d83:	6a 00                	push   $0x0
  pushl $249
80106d85:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
...
80106d8f:	6a 00                	push   $0x0
  pushl $250
80106d91:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
...
80106d9b:	6a 00                	push   $0x0
  pushl $251
80106d9d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
...
80106da7:	6a 00                	push   $0x0
  pushl $252
80106da9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
...
80106db3:	6a 00                	push   $0x0
  pushl $253
80106db5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
...
80106dbf:	6a 00                	push   $0x0
  pushl $254
80106dc1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
...
80106dcb:	6a 00                	push   $0x0
  pushl $255
80106dcd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106dd2:	e9 58 f0 ff ff       	jmp    80105e2f <alltraps>
80106dd7:	66 90                	xchg   %ax,%ax
80106dd9:	66 90                	xchg   %ax,%ax
80106ddb:	66 90                	xchg   %ax,%ax
...
{
80106de8:	89 d7                	mov    %edx,%edi
  pde = &pgdir[PDX(va)];
80106dea:	c1 eb 16             	shr    $0x16,%ebx
80106ded:	8d 34 98             	lea    (%eax,%ebx,4),%esi
{
80106df0:	83 ec 0c             	sub    $0xc,%esp
  if(*pde & PTE_P){
80106df3:	8b 06                	mov    (%esi),%eax
80106df5:	a8 01                	test   $0x1,%al
80106df7:	74 27                	je     80106e20 <walkpgdir+0x40>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106df9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106dfe:	8d 98 00 00 00 80    	lea    -0x80000000(%eax),%ebx
  ...
  return &pgtab[PTX(va)];
80106e04:	c1 ef 0a             	shr    $0xa,%edi
}
80106e07:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return &pgtab[PTX(va)];
80106e0a:	89 fa                	mov    %edi,%edx
80106e0c:	81 e2 fc 0f 00 00    	and    $0xffc,%edx
80106e12:	8d 04 13             	lea    (%ebx,%edx,1),%eax
}
80106e15:	5b                   	pop    %ebx
80106e16:	5e                   	pop    %esi
80106e17:	5f                   	pop    %edi
...
80106e20:	85 c9                	test   %ecx,%ecx
80106e22:	74 2c                	je     80106e50 <walkpgdir+0x70>
80106e24:	e8 97 b6 ff ff       	call   801024c0 <kalloc>
80106e29:	85 c0                	test   %eax,%eax
80106e2b:	89 c3                	mov    %eax,%ebx
80106e2d:	74 21                	je     80106e50 <walkpgdir+0x70>
    memset(pgtab, 0, PGSIZE);
80106e2f:	83 ec 04             	sub    $0x4,%esp
80106e32:	68 00 10 00 00       	push   $0x1000
80106e37:	6a 00                	push   $0x0
80106e39:	50                   	push   %eax
80106e3a:	e8 21 dd ff ff       	call   80104b60 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106e3f:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106e45:	83 c4 10             	add    $0x10,%esp
80106e48:	83 c8 07             	or     $0x7,%eax
80106e4b:	89 06                	mov    %eax,(%esi)
80106e4d:	eb b5                	jmp    80106e04 <walkpgdir+0x24>
80106e4f:	90                   	nop
}
...
80106e71:	89 45 e4             	mov    %eax,-0x1c(%ebp)
...
80106e86:	29 df                	sub    %ebx,%edi
80106e88:	83 c8 01             	or     $0x1,%eax
80106e8b:	89 45 dc             	mov    %eax,-0x24(%ebp)
80106e8e:	eb 15                	jmp    80106ea5 <mappages+0x45>
    if(*pte & PTE_P)
80106e90:	f6 00 01             	testb  $0x1,(%eax)
80106e93:	75 45                	jne    80106eda <mappages+0x7a>
    *pte = pa | perm | PTE_P;
80106e95:	0b 75 dc             	or     -0x24(%ebp),%esi
    if(a == last)
80106e98:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
    *pte = pa | perm | PTE_P;
80106e9b:	89 30                	mov    %esi,(%eax)
    if(a == last)
80106e9d:	74 31                	je     80106ed0 <mappages+0x70>
      break;
    a += PGSIZE;
80106e9f:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106ea5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ea8:	b9 01 00 00 00       	mov    $0x1,%ecx
80106ead:	89 da                	mov    %ebx,%edx
80106eaf:	8d 34 3b             	lea    (%ebx,%edi,1),%esi
80106eb2:	e8 29 ff ff ff       	call   80106de0 <walkpgdir>
80106eb7:	85 c0                	test   %eax,%eax
80106eb9:	75 d5                	jne    80106e90 <mappages+0x30>
    pa += PGSIZE;
  }
  return 0;
}
80106ebb:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
80106ebe:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80106ec3:	5b                   	pop    %ebx
80106ec4:	5e                   	pop    %esi
80106ec5:	5f                   	pop    %edi
...
80106edd:	68 74 80 10 80       	push   $0x80108074
...
80106efc:	89 c7                	mov    %eax,%edi
  a = PGROUNDUP(newsz);
80106efe:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106f04:	83 ec 1c             	sub    $0x1c,%esp
80106f07:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106f0a:	39 d3                	cmp    %edx,%ebx
80106f0c:	73 66                	jae    80106f74 <deallocuvm.part.0+0x84>
80106f0e:	89 d6                	mov    %edx,%esi
80106f10:	eb 3d                	jmp    80106f4f <deallocuvm.part.0+0x5f>
80106f12:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
80106f18:	8b 10                	mov    (%eax),%edx
80106f1a:	f6 c2 01             	test   $0x1,%dl
80106f1d:	74 26                	je     80106f45 <deallocuvm.part.0+0x55>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
80106f1f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106f25:	74 58                	je     80106f7f <deallocuvm.part.0+0x8f>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
80106f27:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106f2a:	81 c2 00 00 00 80    	add    $0x80000000,%edx
80106f30:	89 45 e4             	mov    %eax,-0x1c(%ebp)
      kfree(v);
80106f33:	52                   	push   %edx
80106f34:	e8 d7 b3 ff ff       	call   80102310 <kfree>
      *pte = 0;
...
80106f4b:	39 f3                	cmp    %esi,%ebx
80106f4d:	73 25                	jae    80106f74 <deallocuvm.part.0+0x84>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106f4f:	31 c9                	xor    %ecx,%ecx
80106f51:	89 da                	mov    %ebx,%edx
80106f53:	89 f8                	mov    %edi,%eax
80106f55:	e8 86 fe ff ff       	call   80106de0 <walkpgdir>
    if(!pte)
80106f5a:	85 c0                	test   %eax,%eax
80106f5c:	75 ba                	jne    80106f18 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106f5e:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
80106f64:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106f6a:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106f70:	39 f3                	cmp    %esi,%ebx
80106f72:	72 db                	jb     80106f4f <deallocuvm.part.0+0x5f>
    }
  }
  return newsz;
}
80106f74:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106f82:	68 86 79 10 80       	push   $0x80107986
...
80106f93:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106f96:	e8 f5 c8 ff ff       	call   80103890 <cpuid>
...
80106faa:	c7 80 38 40 11 80 ff 	movl   $0xffff,-0x7feebfc8(%eax)
80106fb1:	ff 00 00 
80106fb4:	c7 80 3c 40 11 80 00 	movl   $0xcf9a00,-0x7feebfc4(%eax)
80106fbb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106fbe:	c7 80 40 40 11 80 ff 	movl   $0xffff,-0x7feebfc0(%eax)
80106fc5:	ff 00 00 
80106fc8:	c7 80 44 40 11 80 00 	movl   $0xcf9200,-0x7feebfbc(%eax)
80106fcf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106fd2:	c7 80 48 40 11 80 ff 	movl   $0xffff,-0x7feebfb8(%eax)
80106fd9:	ff 00 00 
80106fdc:	c7 80 4c 40 11 80 00 	movl   $0xcffa00,-0x7feebfb4(%eax)
80106fe3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106fe6:	c7 80 50 40 11 80 ff 	movl   $0xffff,-0x7feebfb0(%eax)
80106fed:	ff 00 00 
80106ff0:	c7 80 54 40 11 80 00 	movl   $0xcff200,-0x7feebfac(%eax)
80106ff7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106ffa:	05 30 40 11 80       	add    $0x80114030,%eax
  pd[1] = (uint)p;
...
80107020:	a1 e4 79 11 80       	mov    0x801179e4,%eax
{
...
80107064:	0f 84 c2 00 00 00    	je     8010712c <switchuvm+0xec>
  pushcli();
8010706a:	e8 11 d9 ff ff       	call   80104980 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010706f:	e8 9c c7 ff ff       	call   80103810 <mycpu>
80107074:	89 c6                	mov    %eax,%esi
80107076:	e8 95 c7 ff ff       	call   80103810 <mycpu>
8010707b:	89 c7                	mov    %eax,%edi
8010707d:	e8 8e c7 ff ff       	call   80103810 <mycpu>
80107082:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80107085:	83 c7 08             	add    $0x8,%edi
80107088:	e8 83 c7 ff ff       	call   80103810 <mycpu>
...
8010716b:	77 49                	ja     801071b6 <inituvm+0x66>
  mem = kalloc();
8010716d:	e8 4e b3 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
8010717f:	e8 dc d9 ff ff       	call   80104b60 <memset>
...
80107199:	e8 c2 fc ff ff       	call   80106e60 <mappages>
  memmove(mem, init, sz);
...
801071b0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
801071b1:	e9 5a da ff ff       	jmp    80104c10 <memmove>
    panic("inituvm: more than a page");
801071b6:	83 ec 0c             	sub    $0xc,%esp
801071b9:	68 b9 80 10 80       	push   $0x801080b9
...
80107213:	e8 c8 fb ff ff       	call   80106de0 <walkpgdir>
...
80107241:	e8 1a a7 ff ff       	call   80101960 <readi>
...
80107296:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80107299:	8b 7d 10             	mov    0x10(%ebp),%edi
8010729c:	85 ff                	test   %edi,%edi
8010729e:	0f 88 8e 00 00 00    	js     80107332 <allocuvm+0xa2>
  if(newsz < oldsz)
801072a4:	3b 7d 0c             	cmp    0xc(%ebp),%edi
801072a7:	0f 82 93 00 00 00    	jb     80107340 <allocuvm+0xb0>
  a = PGROUNDUP(oldsz);
801072ad:	8b 45 0c             	mov    0xc(%ebp),%eax
801072b0:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
801072b6:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
801072bc:	39 5d 10             	cmp    %ebx,0x10(%ebp)
801072bf:	0f 86 7e 00 00 00    	jbe    80107343 <allocuvm+0xb3>
801072c5:	89 7d e4             	mov    %edi,-0x1c(%ebp)
801072c8:	8b 7d 08             	mov    0x8(%ebp),%edi
801072cb:	eb 42                	jmp    8010730f <allocuvm+0x7f>
...
801072db:	e8 80 d8 ff ff       	call   80104b60 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
801072e0:	58                   	pop    %eax
801072e1:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
801072e7:	b9 00 10 00 00       	mov    $0x1000,%ecx
801072ec:	5a                   	pop    %edx
801072ed:	6a 06                	push   $0x6
801072ef:	50                   	push   %eax
801072f0:	89 da                	mov    %ebx,%edx
801072f2:	89 f8                	mov    %edi,%eax
801072f4:	e8 67 fb ff ff       	call   80106e60 <mappages>
801072f9:	83 c4 10             	add    $0x10,%esp
801072fc:	85 c0                	test   %eax,%eax
801072fe:	78 50                	js     80107350 <allocuvm+0xc0>
  for(; a < newsz; a += PGSIZE){
80107300:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80107306:	39 5d 10             	cmp    %ebx,0x10(%ebp)
80107309:	0f 86 81 00 00 00    	jbe    80107390 <allocuvm+0x100>
    mem = kalloc();
8010730f:	e8 ac b1 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
80107314:	85 c0                	test   %eax,%eax
    mem = kalloc();
80107316:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80107318:	75 b6                	jne    801072d0 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
8010731a:	83 ec 0c             	sub    $0xc,%esp
8010731d:	68 f1 80 10 80       	push   $0x801080f1
80107322:	e8 39 93 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
80107327:	83 c4 10             	add    $0x10,%esp
8010732a:	8b 45 0c             	mov    0xc(%ebp),%eax
8010732d:	39 45 10             	cmp    %eax,0x10(%ebp)
80107330:	77 6e                	ja     801073a0 <allocuvm+0x110>
}
80107332:	8d 65 f4             	lea    -0xc(%ebp),%esp
    return 0;
80107335:	31 ff                	xor    %edi,%edi
}
...
80107353:	68 09 81 10 80       	push   $0x80108109
80107358:	e8 03 93 ff ff       	call   80100660 <cprintf>
  if(newsz >= oldsz)
8010735d:	83 c4 10             	add    $0x10,%esp
80107360:	8b 45 0c             	mov    0xc(%ebp),%eax
80107363:	39 45 10             	cmp    %eax,0x10(%ebp)
80107366:	76 0d                	jbe    80107375 <allocuvm+0xe5>
80107368:	89 c1                	mov    %eax,%ecx
8010736a:	8b 55 10             	mov    0x10(%ebp),%edx
8010736d:	8b 45 08             	mov    0x8(%ebp),%eax
80107370:	e8 7b fb ff ff       	call   80106ef0 <deallocuvm.part.0>
      kfree(mem);
...
8010737b:	e8 90 af ff ff       	call   80102310 <kfree>
      return 0;
...
80107390:	8b 7d e4             	mov    -0x1c(%ebp),%edi
...
801073a2:	8b 55 10             	mov    0x10(%ebp),%edx
801073a5:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
801073a8:	31 ff                	xor    %edi,%edi
801073aa:	e8 41 fb ff ff       	call   80106ef0 <deallocuvm.part.0>
801073af:	eb 92                	jmp    80107343 <allocuvm+0xb3>
801073b1:	eb 0d                	jmp    801073c0 <deallocuvm>
801073b3:	90                   	nop
801073b4:	90                   	nop
801073b5:	90                   	nop
801073b6:	90                   	nop
...
801073d0:	5d                   	pop    %ebp
801073d1:	e9 1a fb ff ff       	jmp    80106ef0 <deallocuvm.part.0>
...
801073fe:	74 59                	je     80107459 <freevm+0x69>
80107400:	31 c9                	xor    %ecx,%ecx
80107402:	ba 00 00 00 80       	mov    $0x80000000,%edx
80107407:	89 f0                	mov    %esi,%eax
80107409:	e8 e2 fa ff ff       	call   80106ef0 <deallocuvm.part.0>
8010740e:	89 f3                	mov    %esi,%ebx
80107410:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80107416:	eb 0f                	jmp    80107427 <freevm+0x37>
80107418:	90                   	nop
...
8010743e:	e8 cd ae ff ff       	call   80102310 <kfree>
80107443:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
80107446:	39 fb                	cmp    %edi,%ebx
...
80107453:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80107454:	e9 b7 ae ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80107459:	83 ec 0c             	sub    $0xc,%esp
8010745c:	68 25 81 10 80       	push   $0x80108125
...
80107475:	e8 46 b0 ff ff       	call   801024c0 <kalloc>
8010747a:	85 c0                	test   %eax,%eax
8010747c:	89 c6                	mov    %eax,%esi
8010747e:	74 42                	je     801074c2 <setupkvm+0x52>
  memset(pgdir, 0, PGSIZE);
80107480:	83 ec 04             	sub    $0x4,%esp
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107483:	bb 20 b4 10 80       	mov    $0x8010b420,%ebx
  memset(pgdir, 0, PGSIZE);
80107488:	68 00 10 00 00       	push   $0x1000
8010748d:	6a 00                	push   $0x0
8010748f:	50                   	push   %eax
80107490:	e8 cb d6 ff ff       	call   80104b60 <memset>
80107495:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80107498:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
8010749b:	8b 4b 08             	mov    0x8(%ebx),%ecx
8010749e:	83 ec 08             	sub    $0x8,%esp
801074a1:	8b 13                	mov    (%ebx),%edx
801074a3:	ff 73 0c             	pushl  0xc(%ebx)
801074a6:	50                   	push   %eax
801074a7:	29 c1                	sub    %eax,%ecx
801074a9:	89 f0                	mov    %esi,%eax
801074ab:	e8 b0 f9 ff ff       	call   80106e60 <mappages>
801074b0:	83 c4 10             	add    $0x10,%esp
801074b3:	85 c0                	test   %eax,%eax
801074b5:	78 19                	js     801074d0 <setupkvm+0x60>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801074b7:	83 c3 10             	add    $0x10,%ebx
801074ba:	81 fb 60 b4 10 80    	cmp    $0x8010b460,%ebx
801074c0:	75 d6                	jne    80107498 <setupkvm+0x28>
}
801074c2:	8d 65 f8             	lea    -0x8(%ebp),%esp
801074c5:	89 f0                	mov    %esi,%eax
801074c7:	5b                   	pop    %ebx
801074c8:	5e                   	pop    %esi
801074c9:	5d                   	pop    %ebp
801074ca:	c3                   	ret    
...
801074f3:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
801074f6:	e8 75 ff ff ff       	call   80107470 <setupkvm>
801074fb:	a3 e4 79 11 80       	mov    %eax,0x801179e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107515:	83 ec 08             	sub    $0x8,%esp
  pte = walkpgdir(pgdir, uva, 0);
80107518:	8b 55 0c             	mov    0xc(%ebp),%edx
8010751b:	8b 45 08             	mov    0x8(%ebp),%eax
8010751e:	e8 bd f8 ff ff       	call   80106de0 <walkpgdir>
  if(pte == 0)
80107523:	85 c0                	test   %eax,%eax
80107525:	74 05                	je     8010752c <clearpteu+0x1c>
    panic("clearpteu");
  *pte &= ~PTE_U;
80107527:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
8010752a:	c9                   	leave  
8010752b:	c3                   	ret    
    panic("clearpteu");
8010752c:	83 ec 0c             	sub    $0xc,%esp
8010752f:	68 36 81 10 80       	push   $0x80108136
...
80107546:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80107549:	e8 22 ff ff ff       	call   80107470 <setupkvm>
8010754e:	85 c0                	test   %eax,%eax
80107550:	89 45 e0             	mov    %eax,-0x20(%ebp)
80107553:	0f 84 9f 00 00 00    	je     801075f8 <copyuvm+0xb8>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107559:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010755c:	85 c9                	test   %ecx,%ecx
8010755e:	0f 84 94 00 00 00    	je     801075f8 <copyuvm+0xb8>
80107564:	31 ff                	xor    %edi,%edi
80107566:	eb 4a                	jmp    801075b2 <copyuvm+0x72>
80107568:	90                   	nop
...
80107573:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
80107579:	68 00 10 00 00       	push   $0x1000
8010757e:	53                   	push   %ebx
8010757f:	50                   	push   %eax
80107580:	e8 8b d6 ff ff       	call   80104c10 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80107585:	58                   	pop    %eax
80107586:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
8010758c:	b9 00 10 00 00       	mov    $0x1000,%ecx
80107591:	5a                   	pop    %edx
80107592:	ff 75 e4             	pushl  -0x1c(%ebp)
80107595:	50                   	push   %eax
80107596:	89 fa                	mov    %edi,%edx
80107598:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010759b:	e8 c0 f8 ff ff       	call   80106e60 <mappages>
801075a0:	83 c4 10             	add    $0x10,%esp
801075a3:	85 c0                	test   %eax,%eax
801075a5:	78 61                	js     80107608 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
801075a7:	81 c7 00 10 00 00    	add    $0x1000,%edi
801075ad:	39 7d 0c             	cmp    %edi,0xc(%ebp)
801075b0:	76 46                	jbe    801075f8 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801075b2:	8b 45 08             	mov    0x8(%ebp),%eax
801075b5:	31 c9                	xor    %ecx,%ecx
801075b7:	89 fa                	mov    %edi,%edx
801075b9:	e8 22 f8 ff ff       	call   80106de0 <walkpgdir>
...
801075c6:	74 4e                	je     80107616 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
801075c8:	89 c3                	mov    %eax,%ebx
    flags = PTE_FLAGS(*pte);
801075ca:	25 ff 0f 00 00       	and    $0xfff,%eax
    pa = PTE_ADDR(*pte);
801075cf:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    flags = PTE_FLAGS(*pte);
801075d5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801075d8:	e8 e3 ae ff ff       	call   801024c0 <kalloc>
801075dd:	85 c0                	test   %eax,%eax
801075df:	89 c6                	mov    %eax,%esi
...
801075f1:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
8010763e:	e8 9d f7 ff ff       	call   80106de0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80107645:	c9                   	leave  
  if((*pte & PTE_U) == 0)
80107646:	89 c2                	mov    %eax,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107648:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  if((*pte & PTE_U) == 0)
8010764d:	83 e2 05             	and    $0x5,%edx
  return (char*)P2V(PTE_ADDR(*pte));
80107650:	05 00 00 00 80       	add    $0x80000000,%eax
80107655:	83 fa 05             	cmp    $0x5,%edx
80107658:	ba 00 00 00 00       	mov    $0x0,%edx
8010765d:	0f 45 c2             	cmovne %edx,%eax
}
80107660:	c3                   	ret    
80107661:	eb 0d                	jmp    80107670 <copyout>
80107663:	90                   	nop
80107664:	90                   	nop
80107665:	90                   	nop
80107666:	90                   	nop
...
80107679:	8b 5d 14             	mov    0x14(%ebp),%ebx
8010767c:	8b 55 0c             	mov    0xc(%ebp),%edx
8010767f:	8b 7d 10             	mov    0x10(%ebp),%edi
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107682:	85 db                	test   %ebx,%ebx
80107684:	75 40                	jne    801076c6 <copyout+0x56>
80107686:	eb 70                	jmp    801076f8 <copyout+0x88>
80107688:	90                   	nop
80107689:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80107690:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107693:	89 f1                	mov    %esi,%ecx
80107695:	29 d1                	sub    %edx,%ecx
80107697:	81 c1 00 10 00 00    	add    $0x1000,%ecx
8010769d:	39 d9                	cmp    %ebx,%ecx
8010769f:	0f 47 cb             	cmova  %ebx,%ecx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801076a2:	29 f2                	sub    %esi,%edx
801076a4:	83 ec 04             	sub    $0x4,%esp
801076a7:	01 d0                	add    %edx,%eax
801076a9:	51                   	push   %ecx
801076aa:	57                   	push   %edi
801076ab:	50                   	push   %eax
801076ac:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
801076af:	e8 5c d5 ff ff       	call   80104c10 <memmove>
    len -= n;
    buf += n;
801076b4:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
  while(len > 0){
801076b7:	83 c4 10             	add    $0x10,%esp
    va = va0 + PGSIZE;
801076ba:	8d 96 00 10 00 00    	lea    0x1000(%esi),%edx
    buf += n;
801076c0:	01 cf                	add    %ecx,%edi
  while(len > 0){
801076c2:	29 cb                	sub    %ecx,%ebx
801076c4:	74 32                	je     801076f8 <copyout+0x88>
    va0 = (uint)PGROUNDDOWN(va);
801076c6:	89 d6                	mov    %edx,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801076c8:	83 ec 08             	sub    $0x8,%esp
    va0 = (uint)PGROUNDDOWN(va);
801076cb:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801076ce:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
801076d4:	56                   	push   %esi
801076d5:	ff 75 08             	pushl  0x8(%ebp)
801076d8:	e8 53 ff ff ff       	call   80107630 <uva2ka>
    if(pa0 == 0)
801076dd:	83 c4 10             	add    $0x10,%esp
801076e0:	85 c0                	test   %eax,%eax
801076e2:	75 ac                	jne    80107690 <copyout+0x20>
  }
  return 0;
}
801076e4:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return -1;
